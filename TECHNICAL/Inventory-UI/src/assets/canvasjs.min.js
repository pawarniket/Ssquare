...
(function () {
  ...
  function Wa(h, l, v) {
    ...
    if (isNaN(w)) {
      try {
        ...
        ua.style.display = "";
        U(ua, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: h, fontSize: l + "px", fontWeight: v });
  ...
  function gb(h) {
    if (h._menuButton) h.exportEnabled ? (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Ja(h._menuButton), pa(h, h._menuButton, "menu")) : ta(h._menuButton);
      ...
      F(
        ...
        function () {
          l ||
            (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }),
              0 >= navigator.userAgent.search("MSIE") && U(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
        },
        h.allDOMEventHandlers,
        !0
      );
      F(
        ...
        function () {
          l ||
            (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }),
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (var v = h._dropdownMenu.childNodes, s = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], sa = 0; sa < v.length; sa++)
        U(v[sa], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), (v[sa].innerHTML = s[sa]);
    } else
      !h._dropdownMenu &&
        h.exportEnabled &&
        w &&
  ...
  function hb(h) {
    if (!ib) {
      var l = !1,
        v = !1;
      "undefined" === typeof na.Chart.creditHref ? ((h.creditHref = ha("iuuqr;..b`ow`rkr/bnl.")), (h.creditText = ha("B`ow`rKR/bnl"))) : ((l = h.updateOption("creditText")), (v = h.updateOption("creditHref")));
      if (h.creditHref && h.creditText) {
        h._creditLink ||
          ((h._creditLink = document.createElement("a")),
            ...
            h._creditLink.style.display = 'none',
            U(h._creditLink, {
              outline: "none",
              margin: "0px",
              position: "absolute",
  ...
  function pa(h, l, v) {
    l.getAttribute("state") ||
      ((l.style.backgroundColor = h.toolbar.itemBackgroundColor), (l.style.color = h.toolbar.fontColor), (l.style.border = "none"), U(l, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
    l.getAttribute("state") !== v &&
      (l.setAttribute("state", v),
        l.setAttribute("type", "button"),
        U(l, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
        (l.innerHTML = "<img src='" + jb[v].image + "' alt='" + h._cultureInfo[v + "Text"] + "' />"),
  ...
  function T(h, l, v, w, y) {
    ...
    this.theme && s(this.parent) && s(l) && s(w)
      ...
      (null === w ? (h = this.parent.themeOptions[l]) : 0 < this.parent.themeOptions[l].length && ((w = Math.min(this.parent.themeOptions[l].length - 1, w)), (h = this.parent.themeOptions[l][w])));
    this.themeOptions = h;
  ...
  var X = 20,
    ...
    Ua = {
      ...
      subtitles: [{ fontFamily: Da, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
      data: [{ indexLabelFontFamily: y, indexLabelFontSize: E, indexLabelFontColor: ca, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
      axisX: [
        {
          titleFontFamily: y,
          titleFontSize: X,
          ...
          crosshair: { labelFontFamily: y, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: W, color: ga, thickness: 1, lineDashType: "dash" },
      ...
      legend: { fontFamily: y, fontSize: 14, fontColor: ca, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
  ...
  var X = 20,
    ...
    $a = {
      ...
      data: [{ indexLabelFontFamily: y, indexLabelFontSize: E, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
      axisX: [
        {
          titleFontFamily: y,
          titleFontSize: X,
  ...
  Da = {
    ...
    data: [{ indexLabelFontFamily: y, indexLabelFontSize: E, indexLabelFontColor: V, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
    axisX: [
      {
        titleFontFamily: y,
        titleFontSize: X,
        ...
        gridColor: L,
        stripLines: [{ labelFontFamily: y, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
        crosshair: { labelFontFamily: y, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: W, color: ga, thickness: 1, lineDashType: "dash" },
    ...
    legend: { fontFamily: y, fontSize: 14, fontColor: ca, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
    toolTip: { fontFamily: y, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: V, backgroundColor: "rgba(0, 0, 0, .7)" },
  };
  L = "#FFFFFF";
  V = ca = "#FAFAFA";
  ga = "#40BAF1";
  ...
  var X = 20,
    ...
    ab = {
      ...
      dark2: {
        ...
        subtitles: [{ fontFamily: y, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
        toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" },
        data: [{ indexLabelFontFamily: y, indexLabelFontSize: E, indexLabelFontColor: V, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [
          {
    ...
    da = function (h, l, v) {
      ...
      for (M = E = J = F = N = 0; 0 < O.length;)
        if (((l = O.pop()), "#" === l || "0" === l))
          ...
          } else 0 < x.length ? ((v = x.pop() + v), F++, M++) : "0" === l && ((v = "0" + v), F++, M++), 0 === M % E && J === S && 0 < x.length && (v = y + v);
        else
  ...
  T.prototype.updateOption = function (h) {
    ...
    this.theme && s(this.parent) && s(E) && s(F)
      ...
      (null === F ? (w = this.parent.themeOptions[E]) : 0 < this.parent.themeOptions[E].length && ((w = Math.min(this.parent.themeOptions[E].length - 1, F)), (w = this.parent.themeOptions[E][w])));
    this.themeOptions = w;
  ...
  T.prototype.addEventListener = function (h, l, s) {
    h && l && ((this._eventListeners[h] = this._eventListeners[h] || []), this._eventListeners[h].push({ context: s || this, eventHandler: l }));
  };
  ...
  T.prototype.dispatchEvent = function (h, l, s) {
    if (h && this._eventListeners[h]) {
      l = l || {};
      for (var w = this._eventListeners[h], y = 0; y < w.length; y++) w[y].eventHandler.call(w[y].context, l);
    }
  ...
  xa.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth && (this.maxWidth = l.width - 4 - x * ("center" === this.horizontalAlign ? 2 : 1)), (F = 0.5 * l.height - this.margin - 2), (E = 0))
        : "center" === this.verticalAlign &&
        ("left" === this.horizontalAlign || "right" === this.horizontalAlign
          ? (null === this.maxWidth && (this.maxWidth = l.height - 4), (F = 0.5 * l.width - this.margin - 2))
          : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = l.width - 4), (F = 0.5 * l.height - 4)));
      var O;
      s(this.padding) || "number" !== typeof this.padding
        ? s(this.padding) ||
        "object" !== typeof this.padding ||
        ((O = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0), (O += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0))
        : (O = 2 * this.padding);
      ...
      O = F.measureText();
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign ? ((y = l.y1 + 2), (M = "top")) : "bottom" === this.verticalAlign && ((y = l.y2 - 2 - O.height), (M = "bottom")),
          "left" === this.horizontalAlign ? (w = l.x1 + 2) : "center" === this.horizontalAlign ? (w = l.x1 + l.width / 2 - O.width / 2) : "right" === this.horizontalAlign && (w = l.x2 - 2 - O.width - x),
          (N = this.horizontalAlign),
          (this.width = O.width),
          (this.height = O.height))
        : "center" === this.verticalAlign &&
        ("left" === this.horizontalAlign
          ? ((w = l.x1 + 2), (y = l.y2 - 2 - (this.maxWidth / 2 - O.width / 2)), (E = -90), (M = "left"), (this.width = O.height), (this.height = O.width))
          : "right" === this.horizontalAlign
            ? ((w = l.x2 - 2), (y = l.y1 + 2 + (this.maxWidth / 2 - O.width / 2)), (E = 90), (M = "right"), (this.width = O.height), (this.height = O.width))
            : "center" === this.horizontalAlign && ((y = h.y1 + (h.height / 2 - O.height / 2)), (w = h.x1 + (h.width / 2 - O.width / 2)), (M = "center"), (this.width = O.width), (this.height = O.height)),
          (N = "center"));
      F.x = w;
      F.y = y;
      F.angle = E;
      F.horizontalAlign = N;
      this._textBlock = F;
      h.layoutManager.registerSpace(M, { width: this.width + ("left" === M || "right" === M ? this.margin + 2 : 0), height: this.height + ("top" === M || "bottom" === M ? this.margin + 2 : 0) });
  ...
  y = Na.Chart = (function () {
      ...
      (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId)
        ? ((this.container.innerHTML = ""),
          ...
          (this._canvasJSContainer.appendChild(this.canvas),
            ...
            (this._canvasJSContainer.appendChild(this.overlaidCanvas), (this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d")), (this.overlaidCanvasCtx.textBaseline = "top"), Aa(this.overlaidCanvasCtx)),
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b = (Math.abs((a[m].x - a[f].x) / (0 === a[m].x - a[u].x ? 0.01 : a[m].x - a[u].x)) * (d - 1)) / 2 + 1;
          var C = (a[m].x - a[f].x) / b;
          b = (a[m].y - a[f].y) / b;
          c[c.length] = (a[u].x > a[f].x && 0 < C) || (a[u].x < a[f].x && 0 > C) ? { x: a[u].x + C / 3, y: a[u].y + b / 3 } : { x: a[u].x, y: a[u].y + b / 9 };
          u = e;
          f = 0 === u ? 0 : u - 1;
          m = u === a.length - 1 ? u : u + 1;
    ...
    function y(a, d, c, b, e, f, m, u, C, k) {
      ...
      a.beginPath();
      C && 0 < u.thickness
        ? (a.moveTo(b - m.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + m.thickness / 2, Math.round((c + e) / 2) - p))
    ...
    function V(a, d, c, b) {
      ...
      if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
        for (a = 0; a < this.options.customBreaks.length; a++)
          this.customBreaks.push(new X(this.chart, "customBreaks", this.options.customBreaks[a], a, ++this.chart._eventManager.lastObjectId, this)),
    ...
    l.prototype.destroy = function () {
      ...
      this._eventManager && this._eventManager.ghostCanvas && wa(this._eventManager.ghostCanvas);
    ...
    l.prototype._updateOptions = function () {
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        if (this._zoomButton)
          U(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
          ...
          F(
            ...
            function () {
              d
                ? (d = !1)
                : (U(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
          ...
          F(
            ...
            function () {
              d ||
                (U(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                  0 >= navigator.userAgent.search("MSIE") && U(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
            },
            this.allDOMEventHandlers
          );
        }
        this._resetButton
          ? (U(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
          ...
          : ((d = !1),
            ...
            F(
              ...
              function () {
                ...
                a.zoomEnabled || a.panEnabled
                  ? ((a.zoomEnabled = !0), (a.panEnabled = !1), pa(a, a._zoomButton, "pan"), (a._defaultCursor = "default"), (a.overlaidCanvas.style.cursor = a._defaultCursor))
            ...
            F(
              ...
              function () {
                d ||
                  (U(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                    0 >= navigator.userAgent.search("MSIE") && U(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
              },
              this.allDOMEventHandlers
            ),
            F(
              ...
              function () {
                d ||
                  (U(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                    0 >= navigator.userAgent.search("MSIE") && U(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
              },
              this.allDOMEventHandlers
            ),
        ...
        this.zoomEnabled ||
          this.panEnabled ||
          (this._zoomButton
            ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? ((this.panEnabled = !0), (this.zoomEnabled = !1)) : ((this.zoomEnabled = !0), (this.panEnabled = !1)), Ja(a._zoomButton, a._resetButton))
            : ((this.zoomEnabled = !0), (this.panEnabled = !1)));
      } else this.panEnabled = this.zoomEnabled = !1;
      gb(this);
      "none" !== this._toolBar.style.display &&
        this._zoomButton &&
        (this.panEnabled ? pa(a, a._zoomButton, "zoom") : pa(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && pa(a, a._resetButton, "reset"));
            ...
            if (this.options.axisY && 0 < this.options.axisY.length) {
              if (!this.axisY.length)
                for (var c = 0; c < this.options.axisY.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push((this.axisY[c] = new x(this, "axisY", this.options.axisY[c], c, "axisY", "left")))
                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY[c] = new x(this, "axisY", this.options.axisY[c], c, "axisY", "bottom")));
              ...
              this.axisY.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push((this.axisY[0] = new x(this, "axisY", this.options.axisY, 0, "axisY", "left")))
                  : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY[0] = new x(this, "axisY", this.options.axisY, 0, "axisY", "bottom")))),
            ...
            if (this.options.axisY2 && 0 < this.options.axisY2.length) {
              if (!this.axisY2.length)
                for (c = 0; c < this.options.axisY2.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push((this.axisY2[c] = new x(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")))
                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY2[c] = new x(this, "axisY2", this.options.axisY2[c], c, "axisY", "top")));
              ...
              this.axisY2.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push((this.axisY2[0] = new x(this, "axisY2", this.options.axisY2, 0, "axisY", "right")))
                  : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY2[0] = new x(this, "axisY2", this.options.axisY2, 0, "axisY", "top")))),
            ...
            if (this.options.axisX && 0 < this.options.axisX.length) {
              if (!this.axisX.length)
                for (c = 0; c < this.options.axisX.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push((this.axisX[c] = new x(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")))
                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX[c] = new x(this, "axisX", this.options.axisX[c], c, "axisX", "left")));
              ...
              this.axisX.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push((this.axisX[0] = new x(this, "axisX", this.options.axisX, 0, "axisX", "bottom")))
                  : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX[0] = new x(this, "axisX", this.options.axisX, 0, "axisX", "left")))),
            ...
            if (this.options.axisX2 && 0 < this.options.axisX2.length) {
              if (!this.axisX2.length)
                for (c = 0; c < this.options.axisX2.length; c++)
                  "normal" === this.plotInfo.axisPlacement
                    ? this._axes.push((this.axisX2[c] = new x(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")))
                    : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX2[c] = new x(this, "axisX2", this.options.axisX2[c], c, "axisX", "right")));
              ...
              this.axisX2.length ||
                ("normal" === this.plotInfo.axisPlacement
                  ? this._axes.push((this.axisX2[0] = new x(this, "axisX2", this.options.axisX2, 0, "axisX", "top")))
                  : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX2[0] = new x(this, "axisX2", this.options.axisX2, 0, "axisX", "right")))),
    ...
    l.prototype.renderElements = function () {
      ...
      this.animatedRender &&
        ...
        c.push({ source: this._breaksCanvasCtx, dest: this.plotArea.ctx, animationCallback: J.fadeInAnimation, easingFunction: J.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 });
      this.animatedRender && 0 < this._indexLabels.length && ((e = ra(this.width, this.height).getContext("2d")), c.push(this.renderIndexLabels(e)));
      var n = this;
      if (0 < c.length)
        (n.disableToolTip = !0),
          n._animator.animate(
              ...
              for (var e = 0; e < c.length; e++)
                (C = c[e]),
                  1 > a && "undefined" !== typeof C.startTimePercent
                    ? a >= C.startTimePercent && C.animationCallback(C.easingFunction(a - C.startTimePercent, 0, 1, 1 - C.startTimePercent), C)
    ...
    l.prototype.categoriseDataSeries = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++) for (c = this.plotInfo.plotTypes[d], m = a = 0; m < c.plotUnits.length; m++) (c.plotUnits[m].previousDataSeriesCount = a), (a += c.plotUnits[m].dataSeriesIndexes.length);
    };
          ...
          for (C = 0; C < u.dataPoints.length; C++) {
            ...
            if (0 < C) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? ((r = e / u.dataPoints[C - 1].y), 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r))
                  : ((r = e - u.dataPoints[C - 1].y), 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r)));
            }
            if (b < q && !k) null !== e && (p = b);
            else {
              if (!k && ((k = !0), 0 < C)) {
    ...
    l.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = [], u = [], C = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (0 < q) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? 0 < e && ((l = e / p.dataPoints[q - 1].y), 1 > l && (l = 1 / l), d.minDiff > l && 1 !== l && (d.minDiff = l))
                  : ((l = e - p.dataPoints[q - 1].y), 0 > l && (l *= -1), d.minDiff > l && 0 !== l && (d.minDiff = l)));
            }
            if (b < nb && !g) null !== p.dataPoints[q].y && (h = b);
              ...
              null === p.dataPoints[q].y
                ...
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  ...
                  0 <= e ? (m[b] ? (m[b] += e) : ((m[b] = e), (C = Math.min(e, C)))) : u[b] ? (u[b] += e) : ((u[b] = e), (k = Math.max(e, k))));
            }
          }
          a.axisY.scaleBreaks &&
            ...
            (d.dataPointYPositiveSums
              ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, m), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, u))
              : ((d.dataPointYPositiveSums = m), (d.dataPointYNegativeSums = u)));
        ...
        for (q in m)
          m.hasOwnProperty(q) &&
            ...
            ((a = m[q]),
              ...
              a > d.max && (d.max = a),
              q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, C)), a > d.viewPortMax && (d.viewPortMax = a)));
        for (q in u)
          u.hasOwnProperty(q) &&
            !isNaN(q) &&
            ((a = u[q]),
        ...
        a.axisY.logarithmic
          ...
          : m && !u
            ...
            : m && u
              ...
              : !m && u && ((d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)), (d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
        d.viewPortMin = d.min;
        d.viewPortMax = d.max;
        a.dataPointYSums = C;
      }
    ...
    l.prototype._processSpecificPlotUnit = function (a) {
      if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if ((u.dataPoints[C].x && u.dataPoints[C].x.getTime) || "dateTime" === u.xValueType) f = !0;
          for (C = 0; C < u.dataPoints.length; C++)
            "undefined" !== typeof u.dataPoints[C].isCumulativeSum && !0 === u.dataPoints[C].isCumulativeSum
              ? ((u.dataPointEOs[C].cumulativeSumYStartValue = 0), (u.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum), (u.dataPoints[C].y = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum))
              : "undefined" !== typeof u.dataPoints[C].isIntermediateSum && !0 === u.dataPoints[C].isIntermediateSum
                ? ((u.dataPointEOs[C].cumulativeSumYStartValue = p),
                  (u.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum),
                  (u.dataPoints[C].y = 0 === C ? 0 : b),
                  (p = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum),
                  (b = 0))
                : ((e = "number" !== typeof u.dataPoints[C].y ? 0 : u.dataPoints[C].y),
                  (u.dataPointEOs[C].cumulativeSumYStartValue = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum),
                  (u.dataPointEOs[C].cumulativeSum = 0 === C ? e : u.dataPointEOs[C - 1].cumulativeSum + e),
                  (b += e));
          for (C = 0; C < u.dataPoints.length; C++)
            if (
              ("undefined" === typeof u.dataPoints[C].x && (u.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0)),
                ...
                b < c.min && (c.min = b),
                b > c.max && (c.max = b),
                u.dataPointEOs[C].cumulativeSum < d.min && (d.min = u.dataPointEOs[C].cumulativeSum),
                u.dataPointEOs[C].cumulativeSum > d.max && (d.max = u.dataPointEOs[C].cumulativeSum),
                0 < C &&
                (a.axisX.logarithmic
                  ? ((p = b / u.dataPoints[C - 1].x), 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p))
                  : ((p = b - u.dataPoints[C - 1].x), 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)),
                  null !== e &&
                  null !== u.dataPoints[C - 1].y &&
                  (a.axisY.logarithmic
                    ? ((e = u.dataPointEOs[C].cumulativeSum / u.dataPointEOs[C - 1].cumulativeSum), 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e))
                    : ((e = u.dataPointEOs[C].cumulativeSum - u.dataPointEOs[C - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))),
                !(b < q) || k)
            ) {
              if (!k && ((k = !0), 0 < C)) {
                C -= 2;
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < C &&
                (u.dataPointEOs[C - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[C - 1].cumulativeSum),
                  u.dataPointEOs[C - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = u.dataPointEOs[C - 1].cumulativeSum));
    ...
    l.prototype.calculateAutoBreaks = function () {
            ...
            for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, m = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, u = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
              ...
              if (!(4 > h.dataPoints.length))
                for (u = 0; u < h.dataPoints.length; u++)
                  if (
                    (b &&
                      ((q = ((k + 1 - m) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                        (g = h.dataPoints[u].x.getTime ? h.dataPoints[u].x.getTime() : h.dataPoints[u].x),
                        (q = Math.floor((g - m) / q)),
                        g < f[q].min && (f[q].min = g),
                        g > f[q].max && (f[q].max = g)),
                      c)
            ...
            if (!(4 > n.dataPoints.length))
              for (m = 0; m < n.dataPoints.length; m++)
                (g = ((d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                  (b = n.dataPoints[m].x.getTime ? n.dataPoints[m].x.getTime() : n.dataPoints[m].x),
                  (g = Math.floor((b - c) / g)),
                  b < f[g].min && (f[g].min = b),
                  b > f[g].max && (f[g].max = b);
          }
      ...
      for (var b, e = this, f = !1, m = 0; m < this._axes.length; m++)
        if (this._axes[m].scaleBreaks && this._axes[m].scaleBreaks.autoCalculate && 1 <= this._axes[m].scaleBreaks.maxNumberOfAutoBreaks) {
          ...
          for (var u = 0; u < 100 / Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) || 10, 10); u++) this._axes[m].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity });
        }
      if (f) {
        for (m = 0; m < this.plotInfo.plotTypes.length; m++)
          for (f = this.plotInfo.plotTypes[m], u = 0; u < f.plotUnits.length; u++)
            (b = f.plotUnits[u]),
              "line" === b.type ||
                "stepLine" === b.type ||
                "spline" === b.type ||
            ...
            if (this._axes[m].scaleBreaks.customBreaks)
              for (u = 0; u < this._axes[m].scaleBreaks.customBreaks.length; u++)
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].endValue) ||
                    (this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].start && f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].endValue) ||
                    (f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].startValue && this._axes[m].scaleBreaks.customBreaks[u].startValue <= f[b].end) ||
                    (f[b].start <= this._axes[m].scaleBreaks.customBreaks[u].endValue && this._axes[m].scaleBreaks.customBreaks[u].endValue <= f[b].end)
                  )
                    f.splice(b, 1), b--;
            f.sort(function (a, b) {
              return b.diff - a.diff;
            });
            for (u = 0; u < Math.min(f.length, this._axes[m].scaleBreaks.maxNumberOfAutoBreaks); u++)
              (b = a(f[u].start, f[u].end, this._axes[m].logarithmic ? this._axes[m].dataInfo.max / this._axes[m].dataInfo.min : this._axes[m].dataInfo.max - this._axes[m].dataInfo.min, this._axes[m].logarithmic)),
                this._axes[m].scaleBreaks.autoBreaks.push(new X(this, "autoBreaks", b, u, ++this._eventManager.lastObjectId, this._axes[m].scaleBreaks)),
            ...
            for (c = 0; c < d.length; c++)
              if (
                ((e = d[c]),
                  ...
                  m.initMouseEvent(e, !0, !0, window, 1, b.screenX, b.screenY, b.clientX, b.clientY, !1, !1, !1, !1, 0, null),
    ...
    l.prototype._mouseEventHandler = function (a) {
      ...
      l.capturedEventParam &&
        ((b = l.capturedEventParam),
          "mouseup" === c && ((l.capturedEventParam = null), b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", b.chart._mouseEventHandler, !1)),
          b.hasOwnProperty(c) &&
      ...
      if (this.interactivityEnabled)
        if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
          ...
          (a.preventManipulation && a.preventManipulation(),
            ...
            Fa && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")),
            !e)
        ) {
              ...
              if (this._events[f].hasOwnProperty(c))
                if (((b = this._events[f]), (e = b.bounds), d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2)) {
                  ...
                  "mousedown" === c && !0 === b.capture
                    ? ((l.capturedEventParam = b), this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1))
    ...
    l.prototype._plotAreaMouseUp = function (a, d) {
      if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
        ...
        if (this.panEnabled || this.zoomEnabled) {
          if (this.panEnabled)
              ...
              (c = this._axes[e]),
                c.logarithmic
                  ? c.viewportMinimum < c.minimum
                    ? ((f = c.minimum / c.viewportMinimum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum * f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum * f), (m = !0))
                    : c.viewportMaximum > c.maximum &&
                    ((f = c.viewportMaximum / c.maximum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum / f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum / f), (m = !0))
                  : c.viewportMinimum < c.minimum
                    ? ((f = c.minimum - c.viewportMinimum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum + f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum + f), (m = !0))
                    : c.viewportMaximum > c.maximum &&
                    ((f = c.viewportMaximum - c.maximum), (c.sessionVariables.newViewportMinimum = c.viewportMinimum - f), (c.sessionVariables.newViewportMaximum = c.viewportMaximum - f), (m = !0));
            ...
            2 < Math.abs(c - e) && 2 < Math.abs(b - f) && this._zoomPanToSelectedRegion(c, b, e, f) && (m = !0);
          }
          m &&
            ((this._ignoreNextEvent = !0),
              ...
              m && this.zoomEnabled && "none" === this._zoomButton.style.display && (Ja(this._zoomButton, this._resetButton), pa(this, this._zoomButton, "pan"), pa(this, this._resetButton, "reset")));
        }
      }
      this.isDrag = !1;
      if ("none" !== this.plotInfo.axisPlacement) {
        ...
        if (this.axisX2 && 0 < this.axisX2.length) for (m = 0; m < this.axisX2.length; m++) this.axisX2[m].crosshair && this.axisX2[m].crosshair.enabled && this.axisX2[m].crosshair.renderLabel();
                  ...
                  return function () {
                    m._zoomPanToSelectedRegion(b, c, e, f, !0) &&
                      (m._dispatchRangeEvent("rangeChanging", "pan"),
                        ...
                        ((m.stockChart._rangeEventParameter.type = "rangeChanging"), m.stockChart.dispatchEvent("rangeChanging", m.stockChart._rangeEventParameter, m.stockChart)),
                        m.render(),
                        m._dispatchRangeEvent("rangeChanged", "pan"),
                        m.stockChart &&
                        m.stockChart.navigator &&
                        m.stockChart.navigator.enabled &&
                        ((m.stockChart._rangeEventParameter.type = "rangeChanged"), m.stockChart.dispatchEvent("rangeChanged", m.stockChart._rangeEventParameter, m.stockChart)),
    ...
    l.prototype.validateRegion = function (a, d, c, b, e) {
      e = e || !1;
      for (var f = 0 <= this.zoomType.indexOf("x"), m = 0 <= this.zoomType.indexOf("y"), u = !1, C = [], k = [], n = [], p = 0; p < this._axes.length; p++)
        (("axisX" === this._axes[p].type && f) || ("axisY" === this._axes[p].type && m)) && k.push(this._axes[p]);
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) A = { chart: this, dataSeries: n.dataSeries, dataPoint: n.dataPoint, index: n.indexKeyword, total: z.total, percent: z.percent };
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== z
              ? ((e = c.y1),
                (f = c.y2),
                0 < y
                  ? ((g = n.point.y + ("horizontal" === A ? r / 2 : 0) - k - u - b), g < e && ((g = "auto" === z ? Math.max(n.point.y, e) + r / 2 + u : e + r / 2 + u), (x = g + k > n.point.y)))
                  : ((g = n.point.y + r / 2 + u + b), g > f - k && ((g = "auto" === z ? Math.min(n.point.y, f) + r / 2 - k - u : f + r / 2 - k), (x = g < n.point.y))))
              : ((e = Math.max(n.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ...
                    : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === A ? u : 0)),
                0 < y
                  ? ((g = Math.max(n.point.y, b)), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(n.point.y - k - u, c.y1 + u)))
                  : ((g = Math.min(n.point.y, b)), g > f - k - u && ("bubble" === p || "scatter" === p) && (g = Math.min(n.point.y + u, c.y2 - k - u))),
                (g = Math.min(g, f)));
          } else
            0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((z = "auto"), (m = 4)) : 0 <= p.indexOf("stacked") ? "auto" === z && (z = "inside") : "bubble" === p && (z = "inside"),
              (g = n.point.y + r / 2 - k / 2 + u),
              "inside" !== z
                ? ((e = c.x1),
                  (f = c.x2),
                  0 > y
                    ? ((q = n.point.x - ("horizontal" === A ? C : C - r / 2) - m - b), q < e && ((q = "auto" === z ? Math.max(n.point.x, e) + m : e + m), (x = q + C > n.point.x)))
                    : ((q = n.point.x + ("horizontal" === A ? 0 : r / 2) + m + b),
                      q > f - C - m - b && ((q = "auto" === z ? Math.min(n.point.x, f) - ("horizontal" === A ? C : C / 2) - m : f - C - m), (x = q < n.point.x))))
                  ...
                  (b =
                    0 <= p.indexOf("range") || "error" === p
                      ? 0 > y
                        ...
                        : Math.min(n.bounds.x2, c.x2) - C / 2 - m + ("horizontal" === A ? 0 : r / 2)
                      : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === A ? 0 : r / 2)),
                  (q = 0 > y ? Math.max(n.point.x, b) - ("horizontal" === A ? C / 2 : 0) : Math.min(n.point.x, b) - C / 2),
                  (q = Math.max(q, e)));
          "vertical" === A && (g += k - r / 2);
          h.x = q;
          h.y = g;
          ...
          B &&
            ...
            ((d.lineWidth = B),
              ...
              0 <= p.indexOf("bar") || ("error" === p && n.axisSwapped)
                ? d.lineTo(q + (0 < n.direction ? -m : C + m) + ("vertical" === A ? -r / 2 : 0), g + ("vertical" === A ? -k / 2 : k / 2 - r / 2) - u)
                : 0 <= p.indexOf("column") || ("error" === p && !n.axisSwapped)
                  ? d.lineTo(q + C / 2 - ("horizontal" === A ? 0 : r / 2), g + ("vertical" === A ? (g - k < n.point.y ? 0 : -k) + u : (g - r / 2 < n.point.y ? k : 0) - r / 2))
                  : d.lineTo(q + C / 2 - ("horizontal" === A ? 0 : r / 2), g + ("vertical" === A ? (g - k < n.point.y ? 0 : -k) : (g - r / 2 < n.point.y ? k : 0) - r / 2)),
              d.stroke());
        }
      }
      d = { source: d, dest: this.plotArea.ctx, animationCallback: J.fadeInAnimation, easingFunction: J.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 };
    ...
    l.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var A = !1, t = 0; t < n.length; t++)
              if (((s = n[t].x.getTime ? n[t].x.getTime() : n[t].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !A)))))
                if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || A || l) && (c.stroke(), w && b.stroke()), (A = !0);
                  ...
                  this._eventManager.objectMap[v] = { id: v, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: t, x1: s, y1: z };
                  l || A
                    ? (!l && k.connectNullData
                      ? (c.setLineDash &&
                        (k.options.nullDataLineDashType || (p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType)) &&
                        (c.stroke(), c.beginPath(), c.moveTo(m.x, m.y), (p = k.nullDataLineDashType), c.setLineDash(q)),
                        c.lineTo(s, z),
                        w && b.lineTo(s, z))
                      : (c.beginPath(), c.moveTo(s, z), w && (b.beginPath(), b.moveTo(s, z))),
                      (A = l = !1))
                    : (c.lineTo(s, z), w && b.lineTo(s, z), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(s, z), w && (b.stroke(), b.beginPath(), b.moveTo(s, z))));
                  m = { x: s, y: z };
                  t < n.length - 1 &&
                  ...
                  if (0 < n[t].markerSize || 0 < k.markerSize) {
                    ...
                    f.push(D);
                    v = Q(v);
                    w && f.push({ x: s, y: z, ctx: b, type: D.type, size: D.size, color: v, borderColor: v, borderThickness: D.borderThickness });
                  }
                  (n[t].indexLabel || k.indexLabel || n[t].indexLabelFormatter || k.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "line", dataPoint: n[t], dataSeries: k, point: { x: s, y: z }, direction: 0 > n[t].y === a.axisY.reversed ? 1 : -1, color: r });
                }
            c.stroke();
            w && b.stroke();
          }
        ...
        c.restore();
        c.beginPath();
        return { source: d, dest: this.plotArea.ctx, animationCallback: J.xClipAnimation, easingFunction: J.easing.linear, animationBase: 0 };
      }
    };
            ...
            for (var A = !1, t = 0; t < n.length; t++)
              if (((s = n[t].getTime ? n[t].x.getTime() : n[t].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !A)))))
                if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || A || l) && (c.stroke(), w && b.stroke()), (A = !0);
                  ...
                  this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: t, x1: s, y1: z };
                  l || A
                    ? (!l && k.connectNullData
                      ? (c.setLineDash &&
                        (k.options.nullDataLineDashType || (p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType)) &&
                      ...
                      : (c.beginPath(), c.moveTo(s, z), w && (b.beginPath(), b.moveTo(s, z))),
                      (A = l = !1))
                    : (c.lineTo(s, v), w && b.lineTo(s, v), c.lineTo(s, z), w && b.lineTo(s, z), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(s, z), w && (b.stroke(), b.beginPath(), b.moveTo(s, z))));
                  m = { x: s, y: z };
                  t < n.length - 1 &&
                    (h !== (n[t].lineColor || r) || p !== (n[t].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                      ...
                      c.setLineDash && (n[t].lineDashType ? ((p = n[t].lineDashType), c.setLineDash(N(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < n[t].markerSize || 0 < k.markerSize)
                    (v = k.getMarkerProperties(t, s, z, c)), f.push(v), (D = Q(D)), w && f.push({ x: s, y: z, ctx: b, type: v.type, size: v.size, color: D, borderColor: D, borderThickness: v.borderThickness });
                  (n[t].indexLabel || k.indexLabel || n[t].indexLabelFormatter || k.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stepLine", dataPoint: n[t], dataSeries: k, point: { x: s, y: z }, direction: 0 > n[t].y === a.axisY.reversed ? 1 : -1, color: r });
                }
            c.stroke();
            w && b.stroke();
          }
    ...
    l.prototype.renderSpline = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              if (((t = n[l].getTime ? n[l].x.getTime() : n[l].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !s)))))
                if ("number" !== typeof n[l].y)
                  0 < l &&
                    !s &&
                    (k.connectNullData
                      ? b.setLineDash && 0 < z.length && (k.options.nullDataLineDashType || !n[l - 1].lineDashType) && ((z[z.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType))
                      : (d(z), (z = []))),
                    (s = !0);
                else {
                  ...
                  this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: l, x1: t, y1: s };
                  z[z.length] = { x: t, y: s };
                  l < n.length - 1 &&
                    (h !== (n[l].lineColor || r) || p !== (n[l].lineDashType || k.lineDashType)) &&
                    ((h = n[l].lineColor || r),
                      (z[z.length - 1].newStrokeStyle = h),
                      b.setLineDash && (n[l].lineDashType ? ((p = n[l].lineDashType), (z[z.length - 1].newLineDashArray = N(p, k.lineThickness))) : ((p = k.lineDashType), (z[z.length - 1].newLineDashArray = g))));
                  if (0 < n[l].markerSize || 0 < k.markerSize) {
                    var Oa = k.getMarkerProperties(l, t, s, b);
                    m.push(Oa);
                    A = Q(A);
                    w && m.push({ x: t, y: s, ctx: e, type: Oa.type, size: Oa.size, color: A, borderColor: A, borderThickness: Oa.borderThickness });
                  }
                  (n[l].indexLabel || k.indexLabel || n[l].indexLabelFormatter || k.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "spline", dataPoint: n[l], dataSeries: k, point: { x: t, y: s }, direction: 0 > n[l].y === a.axisY.reversed ? 1 : -1, color: r });
                  s = !1;
                }
          d(z);
        }
        ...
        b.restore();
        b.beginPath();
        return { source: c, dest: this.plotArea.ctx, animationCallback: J.xClipAnimation, easingFunction: J.easing.linear, animationBase: 0 };
      }
    };
          ...
          if (0 < r.length)
            for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
              if ((r[f].getTime ? (C = r[f].x.getTime()) : (C = r[f].x), !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                ...
                ea(c, a.axisX.reversed ? l : m, u, a.axisX.reversed ? m : l, t, b, 0, null, h && (a.axisY.reversed ? 0 > r[f].y : 0 <= r[f].y), (a.axisY.reversed ? 0 <= r[f].y : 0 > r[f].y) && h, !1, !1, g.fillOpacity);
                b = g.dataPointIds[f];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: m, y1: u, x2: l, y2: t };
                b = Q(b);
            ...
            for (k = 0; k < t.length; k++)
              if (((b = t[k].x.getTime ? t[k].x.getTime() : t[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y)) {
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y))
                  (u[b] = t[k].y + (u[b] ? u[b] : 0)), 0 < u[b] && ((p = a.axisY.convertValueToPixel(u[b])), (A = "undefined" !== typeof f[b] ? f[b] : q), (f[b] = p));
                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y)
                  (C[b] = t[k].y + (C[b] ? C[b] : 0)), (A = a.axisY.convertValueToPixel(C[b])), (p = "undefined" !== typeof m[b] ? m[b] : q), (m[b] = A);
                else if (((p = a.axisY.convertValueToPixel(t[k].y)), 0 <= t[k].y)) {
                  var v = "undefined" !== typeof f[b] ? f[b] : 0;
                  p -= v;
                  A = q - v;
                  f[b] = v + (A - p);
                } else (v = m[b] ? m[b] : 0), (A = p + v), (p = q + v), (m[b] = v + (A - p));
                ...
                b = l.dataPointIds[k];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: n, y1: p, x2: z, y2: A };
                b = Q(b);
            ...
            for (var s = 5 < r && l.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)
              if (((b = t[k].x.getTime ? t[k].x.getTime() : t[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y)) {
                ...
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y)) {
                  ...
                  (C[b] = p + ("undefined" !== typeof C[b] ? C[b] : 0)), (A = a.axisY.convertValueToPixel(C[b])), (p = m[b] ? m[b] : q), (m[b] = A);
          ...
          if (0 < r.length) {
            ...
            for (f = 0; f < r.length; f++)
              if ((r[f].getTime ? (C = r[f].x.getTime()) : (C = r[f].x), !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                ...
                b = g.dataPointIds[f];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: t, y1: u, x2: m, y2: l };
                b = Q(b);
            ...
            for (k = 0; k < t.length; k++)
              if (((b = t[k].x.getTime ? t[k].x.getTime() : t[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y)) {
                ...
                var z = (p + r) << 0,
                  A;
                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y))
                  (u[b] = t[k].y + (u[b] ? u[b] : 0)), 0 < u[b] && ((A = f[b] ? f[b] : q), (f[b] = n = a.axisY.convertValueToPixel(u[b])));
                ...
                b = l.dataPointIds[k];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: A, y1: p, x2: n, y2: z };
                b = Q(b);
          ...
          if (0 < t.length) {
            ...
            for (k = 0; k < t.length; k++)
              if (((b = t[k].x.getTime ? t[k].x.getTime() : t[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y)) {
                ...
                b = l.dataPointIds[k];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: p, x2: n, y2: A };
                b = Q(b);
      ...
      function b() {
        v &&
          (0 < g.lineThickness && f.stroke(),
            a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (A = z) : 0 > a.axisY.viewportMaximum ? (A = u.y1) : 0 < a.axisY.viewportMinimum && (A = z),
            f.lineTo(l, A),
            f.lineTo(v.x, A),
            f.closePath(),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
          ...
          if (0 < r.length) {
            ...
            for (var ba = !0; h < r.length; h++)
              if (((s = r[h].x.getTime ? r[h].x.getTime() : r[h].x), !(s < a.axisX.dataInfo.viewPortMin || (s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ba)))))
                if ("number" !== typeof r[h].y) g.connectNullData || ba || d || b(), (ba = !0);
                else {
                  ...
                  d || ba
                    ? (!d && g.connectNullData
                      ? (f.setLineDash &&
                        ...
                        ((d = l), (c = t), (l = n.x), (t = n.y), b(), f.moveTo(n.x, n.y), (l = d), (t = c), (v = n), (c = g.nullDataLineDashType), f.setLineDash(I)),
                        f.lineTo(l, t),
                        w && m.lineTo(l, t))
                      : (f.beginPath(), f.moveTo(l, t), w && (m.beginPath(), m.moveTo(l, t)), (v = { x: l, y: t })),
                      (ba = d = !1))
                    : (f.lineTo(l, t), w && m.lineTo(l, t), 0 == h % 250 && b());
                  n = { x: l, y: t };
                  h < r.length - 1 &&
                    (x !== (r[h].lineColor || y) || c !== (r[h].lineDashType || g.lineDashType)) &&
                    (b(),
                      (x = r[h].lineColor || y),
                      (f.strokeStyle = x),
                      f.setLineDash && (r[h].lineDashType ? ((c = r[h].lineDashType), f.setLineDash(N(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(R))));
                  var Y = g.dataPointIds[h];
                  this._eventManager.objectMap[Y] = { id: Y, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: l, y1: t };
                  0 !== r[h].markerSize &&
                    (0 < r[h].markerSize || 0 < g.markerSize) &&
                    ((s = g.getMarkerProperties(h, l, t, f)), C.push(s), (Y = Q(Y)), w && C.push({ x: l, y: t, ctx: m, type: s.type, size: s.size, color: Y, borderColor: Y, borderThickness: s.borderThickness }));
                  (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "area", dataPoint: r[h], dataSeries: g, point: { x: l, y: t }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: D });
                }
            b();
            $.drawMarkers(C);
          }
        ...
        w &&
          (e.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
            ...
            this._eventManager.ghostCtx.restore());
        f.restore();
        return { source: e, dest: this.plotArea.ctx, animationCallback: J.xClipAnimation, easingFunction: J.easing.linear, animationBase: 0 };
      }
    };
              ...
              if (((g = p[q].x.getTime ? p[q].x.getTime() : p[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !r)))))
                if ("number" !== typeof p[q].y)
                  0 < q &&
                    !r &&
                    (n.connectNullData
                      ? b.setLineDash && 0 < B.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType) && ((B[B.length - 1].newLineDashArray = x), (D = n.nullDataLineDashType))
                      : (d(), (B = []))),
                    (r = !0);
                else {
                  ...
                  this._eventManager.objectMap[I] = { id: I, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: q, x1: g, y1: r };
                  B[B.length] = { x: g, y: r };
                  q < p.length - 1 &&
                    (y !== (p[q].lineColor || A) || D !== (p[q].lineDashType || n.lineDashType)) &&
                    ((y = p[q].lineColor || A),
                      (B[B.length - 1].newStrokeStyle = y),
                      b.setLineDash && (p[q].lineDashType ? ((D = p[q].lineDashType), (B[B.length - 1].newLineDashArray = N(D, n.lineThickness))) : ((D = n.lineDashType), (B[B.length - 1].newLineDashArray = E))));
                  if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) {
                    var R = n.getMarkerProperties(q, g, r, b);
                    m.push(R);
                    I = Q(I);
                    w && m.push({ x: g, y: r, ctx: e, type: R.type, size: R.size, color: I, borderColor: I, borderThickness: R.borderThickness });
                  }
                  (p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "splineArea", dataPoint: p[q], dataSeries: n, point: { x: g, y: r }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: z });
                  r = !1;
                }
            d();
            $.drawMarkers(m);
    ...
    l.prototype.renderStepArea = function (a) {
      ...
      function b() {
        y &&
          (0 < g.lineThickness && f.stroke(),
            a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (v = z) : 0 > a.axisY.viewportMaximum ? (v = u.y1) : 0 < a.axisY.viewportMinimum && (v = z),
            f.lineTo(s, v),
            f.lineTo(y.x, v),
            f.closePath(),
            (f.globalAlpha = g.fillOpacity),
                ...
                "number" !== typeof r[l].y
                  ...
                  : ((s = a.axisX.convertValueToPixel(B)),
                    ...
                    d || c
                      ? (!d && g.connectNullData
                        ? (f.setLineDash &&
                          (g.options.nullDataLineDashType || (I === g.lineDashType && g.lineDashType !== g.nullDataLineDashType)) &&
                          ((d = s), (c = t), (s = n.x), (t = n.y), b(), f.moveTo(n.x, n.y), (s = d), (t = c), (y = n), (I = g.nullDataLineDashType), f.setLineDash(R)),
                          f.lineTo(s, Y),
                          f.lineTo(s, t),
                          w && (m.lineTo(s, Y), m.lineTo(s, t)))
                        : (f.beginPath(), f.moveTo(s, t), w && (m.beginPath(), m.moveTo(s, t)), (y = { x: s, y: t })),
                        (c = d = !1))
                      : (f.lineTo(s, Y), w && m.lineTo(s, Y), f.lineTo(s, t), w && m.lineTo(s, t), 0 == l % 250 && b()),
                    (n = { x: s, y: t }),
                    l < r.length - 1 &&
                    (E !== (r[l].lineColor || x) || I !== (r[l].lineDashType || g.lineDashType)) &&
                    (b(),
                      (E = r[l].lineColor || x),
                      (f.strokeStyle = E),
                      f.setLineDash && (r[l].lineDashType ? ((I = r[l].lineDashType), f.setLineDash(N(I, g.lineThickness))) : ((I = g.lineDashType), f.setLineDash(ba)))),
                    (B = g.dataPointIds[l]),
                    (this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: l, x1: s, y1: t }),
                    0 !== r[l].markerSize &&
                    (0 < r[l].markerSize || 0 < g.markerSize) &&
                    ((Y = g.getMarkerProperties(l, s, t, f)), h.push(Y), (B = Q(B)), w && h.push({ x: s, y: t, ctx: m, type: Y.type, size: Y.size, color: B, borderColor: B, borderThickness: Y.borderThickness })),
                    (r[l].indexLabel || g.indexLabel || r[l].indexLabelFormatter || g.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stepArea", dataPoint: r[l], dataSeries: g, point: { x: s, y: t }, direction: 0 > r[l].y === a.axisY.reversed ? 1 : -1, color: D }));
              }
            b();
            $.drawMarkers(h);
          }
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !Y))))
                if ("number" !== typeof fa.y) D.connectNullData || Y || B || d(), (Y = !0);
                  ...
                  B || Y
                    ? (!B && D.connectNullData
                      ? (b.setLineDash &&
                        (D.options.nullDataLineDashType || (z === D.lineDashType && D.lineDashType !== D.nullDataLineDashType)) &&
                        ((B = k.pop()), (z = k[k.length - 1]), d(), b.moveTo(t.x, t.y), k.push(z), k.push(B), (z = D.nullDataLineDashType), b.setLineDash(R)),
                        b.lineTo(g, r),
                        w && s.lineTo(g, r))
                      : (b.beginPath(), b.moveTo(g, r), w && (s.beginPath(), s.moveTo(g, r))),
                      (Y = B = !1))
                    : (b.lineTo(g, r), w && s.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && s.moveTo(g, r), k.push({ x: g, y: l - la })));
                  t = { x: g, y: r };
                  q < x.length - 1 &&
                    (I !== (x[q].lineColor || E) || z !== (x[q].lineDashType || D.lineDashType)) &&
                    (d(),
                      b.beginPath(),
                      b.moveTo(g, r),
                      k.push({ x: g, y: l - la }),
                      (I = x[q].lineColor || E),
                      (b.strokeStyle = I),
                      b.setLineDash && (x[q].lineDashType ? ((z = x[q].lineDashType), b.setLineDash(N(z, D.lineThickness))) : ((z = D.lineDashType), b.setLineDash(ba))));
                  if (0 <= D.dataPointIndexes[f]) {
                    var aa = D.dataPointIds[D.dataPointIndexes[f]];
                    this._eventManager.objectMap[aa] = { id: aa, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: D.dataPointIndexes[f], x1: g, y1: r };
                  }
                  0 <= D.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < D.markerSize) &&
                    ((la = D.getMarkerProperties(D.dataPointIndexes[f], g, r, b)),
                      m.push(la),
                      (f = Q(aa)),
                      w && m.push({ x: g, y: r, ctx: s, type: la.type, size: la.size, color: f, borderColor: f, borderThickness: la.borderThickness }));
                  (fa.indexLabel || D.indexLabel || fa.indexLabelFormatter || D.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: D, point: { x: g, y: r }, direction: 0 > x[q].y === a.axisY.reversed ? 1 : -1, color: e });
                }
            }
            d();
            b.moveTo(g, r);
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !Y))))
                if ("number" !== typeof fa.y) D.connectNullData || Y || s || d(), (Y = !0);
                  ...
                  s || Y
                    ? (!s && D.connectNullData
                      ? (b.setLineDash &&
                        (D.options.nullDataLineDashType || (t === D.lineDashType && D.lineDashType !== D.nullDataLineDashType)) &&
                        ((s = k.pop()), (t = k[k.length - 1]), d(), b.moveTo(l.x, l.y), k.push(t), k.push(s), (t = D.nullDataLineDashType), b.setLineDash(R)),
                        b.lineTo(g, r),
                        w && z.lineTo(g, r))
                      : (b.beginPath(), b.moveTo(g, r), w && (z.beginPath(), z.moveTo(g, r))),
                      (Y = s = !1))
                    : (b.lineTo(g, r), w && z.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && z.moveTo(g, r), k.push({ x: g, y: B - aa })));
                  l = { x: g, y: r };
                  q < x.length - 1 &&
                    (I !== (x[q].lineColor || E) || t !== (x[q].lineDashType || D.lineDashType)) &&
                    (d(),
                      b.beginPath(),
                      b.moveTo(g, r),
                      k.push({ x: g, y: B - aa }),
                      (I = x[q].lineColor || E),
                      (b.strokeStyle = I),
                      b.setLineDash && (x[q].lineDashType ? ((t = x[q].lineDashType), b.setLineDash(N(t, D.lineThickness))) : ((t = D.lineDashType), b.setLineDash(ba))));
                  if (0 <= D.dataPointIndexes[f]) {
                    var G = D.dataPointIds[D.dataPointIndexes[f]];
                    this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: D.dataPointIndexes[f], x1: g, y1: r };
                  }
                  0 <= D.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < D.markerSize) &&
                    ((aa = D.getMarkerProperties(q, g, r, b)), u.push(aa), (f = Q(G)), w && u.push({ x: g, y: r, ctx: z, type: aa.type, size: aa.size, color: f, borderColor: f, borderThickness: aa.borderThickness }));
                  (fa.indexLabel || D.indexLabel || fa.indexLabelFormatter || D.indexLabelFormatter) &&
                    this._indexLabels.push({ chartType: "stackedArea100", dataPoint: fa, dataSeries: D, point: { x: g, y: r }, direction: 0 > x[q].y === a.axisY.reversed ? 1 : -1, color: e });
                }
            }
            d();
            b.moveTo(g, r);
    ...
    l.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 25 * Math.PI, l = Math.max(Math.pow((0.25 * Math.min(b.height, b.width)) / 2, 2) * Math.PI, r), k = 0; k < a.dataSeriesIndexes.length; k++)
          if (((n = a.dataSeriesIndexes[k]), (p = this.data[n]), (q = p.dataPoints), 0 < q.length))
            for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
              if (((f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y)) {
                ...
                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: f, y1: m, size: s };
                s = Q(t);
        ...
        w &&
          (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
            ...
            this._eventManager.ghostCtx.restore());
        c.restore();
        return { source: d, dest: this.plotArea.ctx, animationCallback: J.fadeInAnimation, easingFunction: J.easing.easeInQuad, animationBase: 0 };
      }
    };
          ...
          if (0 < n.length) {
            ...
            for (var p = 0, q = 0, e = 0; e < n.length; e++)
              if (((f = n[e].getTime ? (f = n[e].x.getTime()) : (f = n[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y)) {
                ...
                c.globalAlpha = 1;
                (Math.sqrt((p - f) * (p - f) + (q - m) * (q - m)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                  ((p = k.dataPointIds[e]),
                    (this._eventManager.objectMap[p] = { id: p, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e, x1: f, y1: m }),
                    (p = Q(p)),
            ...
            for (var z = 5 < r && t.bevelEnabled ? !0 : !1, u = 0; u < B.length; u++)
              if (
                ...
                var A = (h - r / 2) << 0,
                  ...
                  x = 0 === D % 2 ? 0 : 0.5,
                  E = t.dataPointIds[u];
                this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: u, x1: A, y1: k, x2: y, y2: n, x3: h, y3: p, x4: h, y4: q, borderThickness: D, color: e };
                c.strokeStyle = e;
                c.beginPath();
                c.lineWidth = D;
                ...
                "candlestick" === t.type
                  ? (c.moveTo(h - x, n),
                    ...
                    c.lineTo(h - x, p),
                    c.stroke(),
                    ea(c, A, Math.min(k, q), y, Math.max(k, q), B[u].y[0] <= B[u].y[3] ? t.risingColor : f, D, e, z, z, !1, !1, t.fillOpacity),
                    w &&
                    ((e = Q(E)),
                      (b.strokeStyle = e),
                      b.moveTo(h - x, n),
                      ...
                      b.lineTo(h - x, p),
                      b.stroke(),
                      ea(b, A, Math.min(k, q), y, Math.max(k, q), e, 0, null, !1, !1, !1, !1)))
                  : "ohlc" === t.type &&
                  (c.moveTo(h - x, n),
                    c.lineTo(h - x, p),
                    c.stroke(),
                    ...
                    ((e = Q(E)),
                      ...
                      b.lineTo(y, q),
                      b.stroke()));
                (B[u].indexLabel || t.indexLabel || B[u].indexLabelFormatter || t.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: t.type,
                    dataPoint: B[u],
                    dataSeries: t,
            ...
            for (var A = 5 < r && B.bevelEnabled ? !0 : !1, m = 0; m < z.length; m++)
              if (
                ...
                var y = (u - r / 2) << 0,
                  ...
                  E = 0 === x % 2 ? 0 : 0.5,
                  I = z[m].whiskerColor ? z[m].whiskerColor : z[m].color ? (B.whiskerColor ? B.whiskerColor : z[m].color) : B.whiskerColor ? B.whiskerColor : e,
                  ...
                  la = z[m].stemColor ? z[m].stemColor : z[m].color ? (B.stemColor ? B.stemColor : z[m].color) : B.stemColor ? B.stemColor : e,
                ...
                c.save();
                0 < aa &&
                  (c.beginPath(), (c.strokeStyle = la), (c.lineWidth = aa), c.setLineDash && c.setLineDash(N(F, aa)), c.moveTo(u - G, k), c.lineTo(u - G, h), c.stroke(), c.moveTo(u - G, p), c.lineTo(u - G, n), c.stroke());
                c.restore();
                ...
                c.stroke();
                c.save();
                0 < L && (c.beginPath(), (c.globalAlpha = 1), c.setLineDash && c.setLineDash(N(O, L)), (c.strokeStyle = M), (c.lineWidth = L), c.moveTo(y, q - K), c.lineTo(D, q - K), c.stroke());
                c.restore();
                c.save();
                0 < R &&
                  (c.beginPath(),
                ...
                w &&
                  ((e = Q(P)),
                    (b.strokeStyle = e),
                    (b.lineWidth = aa),
                    0 < aa && (b.moveTo(u - E - G, k), b.lineTo(u - E - G, Math.max(h, p)), b.stroke(), b.moveTo(u - E - G, Math.min(h, p)), b.lineTo(u - E - G, n), b.stroke()),
                    ea(b, y, Math.max(k, n), D, Math.min(k, n), e, 0, null, !1, !1, !1, !1),
                    0 < R && (b.beginPath(), (b.lineWidth = R), b.moveTo(u + Y / 2, p - fa), b.lineTo(u - Y / 2, p - fa), b.stroke(), b.moveTo(u + Y / 2, h + fa), b.lineTo(u - Y / 2, h + fa), b.stroke()));
                (z[m].indexLabel || B.indexLabel || z[m].indexLabelFormatter || B.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: B.type,
                    dataPoint: z[m],
                    dataSeries: B,
          ...
          if (0 < g.length)
            for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
              if (
                ...
                t = q.dataPointIds[f];
                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: l, y1: m, x2: v, y2: u };
                ea(c, a.axisX.reversed ? v : l, m, a.axisX.reversed ? l : v, u, b, 0, b, r, r, !1, !1, q.fillOpacity);
                b = Q(t);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          var z = a.dataSeriesIndexes[B],
            A = this.data[z],
            x = A.dataPoints,
            D = s(A._linkedSeries) ? !1 : A._linkedSeries.type.match(/(bar|column)/gi) && A._linkedSeries.visible ? !0 : !1,
            E = 0;
          if (D)
            for (e = A._linkedSeries.id, t = 0; t < e; t++)
              !this.data[t].type.match(/(bar|column)/gi) || !this.data[t].visible || (this.data[t].type.match(/(stacked)/gi) && E) || (this.data[t].type.match(/(range)/gi) && (f = !0), E++);
          e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
          ...
          f &&
            (u = this.options.dataPointMaxWidth
              ...
              : this.options.dataPointWidth
                ? this.dataPointWidth
                : b
                  ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (D ? v : 1))) << 0
                  : 0.03 * this.width);
          t = this.options.dataPointWidth ? this.dataPointWidth : (0.9 * (((b ? m.height : m.width) * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range))) / (D ? v : 1))) << 0;
          ...
          if (0 < x.length)
            for (var F = A._colorSet, u = 0; u < x.length; u++) {
              ...
              I.length = "number" === typeof I.length ? (0 >= I.length ? 0 : I.length >= t ? t : I.length) : "string" === typeof I.length ? ((parseInt(I.length) * t) / 100 > t ? t : (parseInt(I.length) * t) / 100 > t) : t;
              ...
              if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] && "number" === typeof x[u].y[1]) {
                ...
                b ? (p = ba) : (g = ba);
                b
                  ? ((q = a.axisX.reversed ? (k + ((D ? v : 1) * t) / 2 - (D ? E - 1 : 0) * t) << 0 : (k - ((D ? v : 1) * t) / 2 + (D ? E - 1 : 0) * t) << 0), (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                  : ((n = a.axisX.reversed ? (h + ((D ? v : 1) * t) / 2 - (D ? E - 1 : 0) * t) << 0 : (h - ((D ? v : 1) * t) / 2 + (D ? E - 1 : 0) * t) << 0), (p = a.axisX.reversed ? (n - t) << 0 : (n + t) << 0));
                !b && q > g && ((ba = q), (q = g), (g = ba));
                b && n > p && ((ba = n), (n = p), (p = ba));
                ba = A.dataPointIds[u];
                ...
                if (x[u].indexLabel || A.indexLabel || x[u].indexLabelFormatter || A.indexLabelFormatter)
                  this._indexLabels.push({
                    chartType: "error",
                    dataPoint: x[u],
                    dataSeries: A,
                    indexKeyword: 0,
                    point: { x: b ? (x[u].y[1] >= x[u].y[0] ? n : p) : n + (p - n) / 2, y: b ? q + (g - q) / 2 : x[u].y[1] >= x[u].y[0] ? g : q },
                    ...
                    this._indexLabels.push({
                      ...
                      dataSeries: A,
                      indexKeyword: 1,
                      point: { x: b ? (x[u].y[1] >= x[u].y[0] ? p : n) : n + (p - n) / 2, y: b ? q + (g - q) / 2 : x[u].y[1] >= x[u].y[0] ? q : g },
                      direction: x[u].y[1] >= x[u].y[0] ? 1 : -1,
                      bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, p) : p, y2: b ? g : Math.max(q, g) },
                      color: e,
                      axisSwapped: b,
          ...
          if (0 < r.length) {
            ...
            for (f = 0; f < r.length; f++)
              if (
                ...
                b = g.dataPointIds[f];
                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: m, y1: h, x2: u, y2: v };
                b = Q(b);
        ...
        for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < p.length) {
            ...
            for (var I = !0; g < p.length; g++)
              if (((t = p[g].x.getTime ? p[g].x.getTime() : p[g].x), !(t < a.axisX.dataInfo.viewPortMin || (t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !I)))))
                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                  ...
                  q || I
                    ? (n.connectNullData && !q
                      ? (b.setLineDash &&
                        (n.options.nullDataLineDashType || (D === n.lineDashType && n.lineDashType !== n.nullDataLineDashType)) &&
                        ((h[h.length - 1].newLineDashArray = E), (D = n.nullDataLineDashType), b.setLineDash(y)),
                        b.lineTo(r, l),
                        w && e.lineTo(r, l),
                        h.push({ x: r, y1: l, y2: s }))
                      : (b.beginPath(), b.moveTo(r, l), (v = { x: r, y: l }), (h = []), h.push({ x: r, y1: l, y2: s }), w && (e.beginPath(), e.moveTo(r, l))),
                      (I = q = !1))
                    : (b.lineTo(r, l), h.push({ x: r, y1: l, y2: s }), w && e.lineTo(r, l), 0 == g % 250 && d());
                  t = n.dataPointIds[g];
                  this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: r, y1: l, y2: s };
                  g < p.length - 1 &&
                    (x !== (p[g].lineColor || A) || D !== (p[g].lineDashType || n.lineDashType)) &&
                    (d(),
                      (x = p[g].lineColor || A),
                      ...
                      b.setLineDash &&
                      (p[g].lineDashType
                        ? ((D = p[g].lineDashType), (h[h.length - 1].newLineDashArray = N(D, n.lineThickness)), b.setLineDash(h[h.length - 1].newLineDashArray))
                        : ((D = n.lineDashType), (h[h.length - 1].newLineDashArray = E), b.setLineDash(E))));
                  if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                    var R = n.getMarkerProperties(g, r, s, b);
                    f.push(R);
                    var ba = Q(t);
                    w && f.push({ x: r, y: s, ctx: e, type: R.type, size: R.size, color: ba, borderColor: ba, borderThickness: R.borderThickness });
                    R = n.getMarkerProperties(g, r, l, b);
                    f.push(R);
                    ba = Q(t);
                    w && f.push({ x: r, y: l, ctx: e, type: R.type, size: R.size, color: ba, borderColor: ba, borderThickness: R.borderThickness });
                  }
                  if (p[g].indexLabel || n.indexLabel || p[g].indexLabelFormatter || n.indexLabelFormatter)
                    this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 0, point: { x: r, y: l }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: z }),
                      this._indexLabels.push({
                        chartType: "rangeArea",
                        dataPoint: p[g],
                        dataSeries: n,
            ...
            for (g = !1; p < n.length; p++)
              if (((q = n[p].x.getTime ? n[p].x.getTime() : n[p].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                  ...
                  this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: p, x1: q, y1: g, y2: r };
                  s[s.length] = { x: q, y: g };
                  x[x.length] = { x: q, y: r };
                  p < n.length - 1 &&
                    (z !== (n[p].lineColor || B) || A !== (n[p].lineDashType || k.lineDashType)) &&
                    ((z = n[p].lineColor || B),
                      (s[s.length - 1].newStrokeStyle = z),
                      b.setLineDash && (n[p].lineDashType ? ((A = n[p].lineDashType), (s[s.length - 1].newLineDashArray = N(A, k.lineThickness))) : ((A = k.lineDashType), (s[s.length - 1].newLineDashArray = y))));
                  if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) {
                    var F = k.getMarkerProperties(p, q, g, b);
                    f.push(F);
                    var I = Q(E);
                    w && f.push({ x: q, y: g, ctx: e, type: F.type, size: F.size, color: I, borderColor: I, borderThickness: F.borderThickness });
                    F = k.getMarkerProperties(p, q, r, b);
                    f.push(F);
                    I = Q(E);
                    w && f.push({ x: q, y: r, ctx: e, type: F.type, size: F.size, color: I, borderColor: I, borderThickness: F.borderThickness });
                  }
                  ...
                  0 < p &&
                    !g &&
                    (k.connectNullData
                      ? b.setLineDash && 0 < s.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = D), (A = k.nullDataLineDashType))
                      : (d(y, B), (s = []), (x = []))),
                    (g = !0);
            d(y, B);
            $.drawMarkers(f);
          ...
          if (0 < v.length)
            for (var z = 5 < q && s.bevelEnabled ? !0 : !1, x = !1, y = null, D = null, m = 0; m < v.length; m++)
              if ((v[m].getTime ? (n = v[m].x.getTime()) : (n = v[m].x), "number" !== typeof v[m].y)) {
                if (0 < m && !x && s.connectNullData) var E = s.options.nullDataLineDashType || !v[m - 1].lineDashType ? s.nullDataLineDashType : v[m - 1].lineDashType;
                x = !0;
              } else {
                ...
                e = s.dataPointIds[m];
                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: m, x1: h, y1: l, x2: F, y2: k };
                ...
                e = Q(e);
                w && ea(this._eventManager.ghostCtx, a.axisX.reversed ? F : h, l, a.axisX.reversed ? h : F, k, e, 0, null, !1, !1, !1, !1);
                var R,
                  I = h;
                R =
                  ("undefined" !== typeof v[m].isIntermediateSum && !0 === v[m].isIntermediateSum) || ("undefined" !== typeof v[m].isCumulativeSum && !0 === v[m].isCumulativeSum)
                    ? 0 < v[m].y
                      ? l
                      : k
                    : 0 < v[m].y
                ...
                0 < m &&
                  ...
                  (x && c.setLineDash && c.setLineDash(N(E, t)),
                    ...
                    c.lineTo(I, R - B),
                    0 < t && c.stroke(),
                    w && (b.beginPath(), b.moveTo(y, D - B), b.lineTo(I, R - B), 0 < t && b.stroke()));
                x = !1;
                y = F;
                D = 0 < v[m].y ? l : k;
                I = v[m].lineDashType ? v[m].lineDashType : s.options.lineDashType ? s.options.lineDashType : "shortDash";
                ...
                (v[m].indexLabel || s.indexLabel || v[m].indexLabelFormatter || s.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "waterfall",
                    dataPoint: v[m],
                    dataSeries: s,
    ...
    var ha = function (a, d, c, b, e, f, m, h, l) {
      if (!(0 > c)) {
        ...
        a.globalAlpha = h;
        "pie" === e
          ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, m, !1), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.closePath(), a.fill())
          : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, m, !1), 0 <= l && a.arc(d.x, d.y, l * c, m, f, !0), a.closePath(), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
        a.globalAlpha = 1;
        a.restore();
      }
    };
      ...
      function d() {
        if (k && n) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
            ...
            if (k.indexLabelFormatter || f.indexLabelFormatter) u = { chart: l.options, dataSeries: k, dataPoint: f, total: p.total, percent: p.percent };
          ...
          for (e = 0; e < n.length; e++)
            (h = g[(c + e) % n.length]), 1 < a && h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t && (f <= a / 2 && !p ? ((h.hemisphere = "right"), f++) : ((h.hemisphere = "left"), (p = !0)));
          p = !1;
          for (e = 0; e < n.length; e++)
            (h = g[(d + e) % n.length]), 1 < b && h.midAngle > (3 * Math.PI) / 2 - t && h.midAngle < (3 * Math.PI) / 2 + t && (m <= b / 2 && !p ? ((h.hemisphere = "left"), m++) : ((h.hemisphere = "right"), (p = !0)));
        }
      }
      function c(a) {
          ...
          0 > c
            ? ((h = "right" === p.hemisphere ? l : q),
              ...
              ((l = -c),
                ...
                c - l < r && ((k = -l), (h = f(h, k, d + 1)), +h.toFixed(B) > +k.toFixed(B) && (m = c > r ? -(c - r) : -(l - (h - k))))))
            : 0 < c &&
            ((h = "right" === p.hemisphere ? q : l),
              ...
              ((l = c),
                ...
                c - l < r && ((k = l), (h = f(h, k, d + 1)), +h.toFixed(B) < +k.toFixed(B) && (m = c > r ? c - r : l - (k - h)))));
          m &&
            ((d = p.indexLabelTextBlock.y + m),
              (c = 0),
              (c = "right" === p.hemisphere ? z.x + Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2))),
              ...
              (p.indexLabelAngle = Math.atan2(p.indexLabelTextBlock.y - z.y, p.indexLabelTextBlock.x - z.x)));
        }
        return m;
      }
      function m() {
              ...
              if (null !== t) {
                ...
                if (0 > x) {
                  ...
                  var A = -1 * (x - s),
                    J = (y = 0);
                  "right" === h.hemisphere
                    ? ((y = f(a, s)), (A = -1 * (x - y)), (J = f(t, A)), +J.toFixed(B) < +A.toFixed(B) && +y.toFixed(B) <= +s.toFixed(B) && f(a, -(A - J)))
                    : ((y = f(t, s)), (A = -1 * (x - y)), (J = f(a, A)), +J.toFixed(B) < +A.toFixed(B) && +y.toFixed(B) <= +s.toFixed(B) && f(t, -(A - J)));
                }
              }
            }
          } else
            for (a = 0; a < n.length; a++)
              (h = g[a]), (v = "pie" === k.type ? 0.7 * D : 0.8 * D), (t = z.x + v * Math.cos(h.midAngle)), (s = z.y + v * Math.sin(h.midAngle)), (h.indexLabelTextBlock.x = t), (h.indexLabelTextBlock.y = s);
          for (a = 0; a < n.length; a++)
            if (((h = g[a]), (t = h.indexLabelTextBlock.measureText()), 0 !== t.height && 0 !== t.width))
              (t = t = 0),
                ...
                (!m &&
                  ...
                  Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - z.y) < D || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - z.y) < D) &&
                ...
                0 < t &&
                (!m && h.indexLabelText && ((s = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1), 0 === f(a, t * s) && f(a, 2 * s)),
                  Math.abs(h.indexLabelTextBlock.x - z.x) < D && ((t /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < t && (t *= 0.3), t > d && (d = t)));
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (var m = (d[0] = 0), h = 0, n, p, b = b - a, m = !1, k = 0; k < B.length; k++)
          (a = (Math.abs(B[k].y) * f) / g),
            m
              ? (n = 0 == Number(c.toFixed(3)) ? 0 : a / c)
              : ((p = X * X * b * b - 4 * Math.abs(X) * a),
                0 > p
                  ? ((p = c), (m = ((b + p) * (e - h)) / 2), (a -= m), (n = e - h), (h += e - h), (n += 0 == p ? 0 : a / p), (h += a / p), (m = !0))
                  : ((n = (Math.abs(X) * b - Math.sqrt(p)) / 2),
                    (p = b - (2 * n) / Math.abs(X)),
                    (h += n),
                    h > e && ((h -= n), (p = c), (m = ((b + p) * (e - h)) / 2), (a -= m), (n = e - h), (h += e - h), (n += a / p), (h += a / p), (m = !0)),
                    (b = p))),
            d.push(n);
        return d;
      }
      function b() {
        if (t && B) {
          for (var a, b, c, d, e, f, k, m, h, n, p, q, l, u, r, C = [], v = [], z = { percent: null, total: null }, y = null, A = 0; A < B.length; A++)
            (r = P[A]), (r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2), (r = g(r).x2 + 1), (C[A] = L - r - S);
          r = 0.5 * S;
          for (var A = 0, D = B.length - 1; A < B.length || 0 <= D; A++, D--) {
            ...
            l = t.dataPointIds[A];
            x._eventManager.objectMap[l] = { id: l, objectType: "dataPoint", dataPointIndex: A, dataSeriesIndex: 0, funnelSection: P[t.reversed ? B.length - 1 - A : A] };
            "inside" === t.indexLabelPlacement &&
              ((C[A] = A !== ca ? (t.reversed ? P[A].x2 - P[A].x1 : P[A].x3 - P[A].x4) : P[A].x3 - P[A].x6),
                20 > C[A] && ((C[A] = A !== ca ? (t.reversed ? P[A].x3 - P[A].x4 : P[A].x2 - P[A].x1) : P[A].x2 - P[A].x1), (C[A] /= 2)));
            l = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth : C[A];
            if (l > C[A] || 0 > l) l = C[A];
            v[A] = "inside" === t.indexLabelPlacement ? P[A].height : !1;
            z = x.getPercentAndTotal(t, b);
            if (t.indexLabelFormatter || b.indexLabelFormatter) y = { chart: x.options, dataSeries: t, dataPoint: b, total: z.total, percent: z.percent };
        ...
        if (e)
          for (m = H.length - 1; 0 <= m; m--)
            (a = P[m]),
              ...
              (H[m].textBlock.x = L - k),
              (c = H[m].textBlock.height < H[m].textBlock.maxHeight ? H[m].textBlock.height : H[m].textBlock.maxHeight),
              (e = H[m].textBlock.width < H[m].textBlock.maxWidth ? H[m].textBlock.width : H[m].textBlock.maxWidth),
              (H[m].height = c),
              (H[m].width = e),
              (c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2),
              (H[m].textBlock.y = c - H[m].height / 2),
              t.reversed
                ? (H[m].textBlock.y + H[m].height > V + A && (H[m].textBlock.y = V + A - H[m].height), H[m].textBlock.y < qa - A && (H[m].textBlock.y = qa - A))
                : (H[m].textBlock.y < V - A && (H[m].textBlock.y = V - A), H[m].textBlock.y + H[m].height > qa + A && (H[m].textBlock.y = qa + A - H[m].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < P.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = P[e]),
                ...
                t.reversed
                  ? (H[e].textBlock.y + H[e].height > V + A && (H[e].textBlock.y = V + A - H[e].height), H[e].textBlock.y < qa - A && (H[e].textBlock.y = qa - A))
                  : (H[e].textBlock.y < V - A && (H[e].textBlock.y = V - A), H[e].textBlock.y + H[e].height > qa + A && (H[e].textBlock.y = qa + A - H[e].height)));
        else
          for (e = 0; e < P.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = P[e]),
                ...
                (d = H[e].width),
                b >= c
                  ? ((b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2), (c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2), (H[e].textBlock.x = b), (H[e].textBlock.y = c))
                  : (H[e].isDirty = !0));
      }
      function m() {
        function a(b, c) {
          ...
          for (var k, h = 1; h < m; h++) {
            ...
            for (var l = H.length - 1; 0 <= l; l--)
              !H[l].isDirty &&
                ...
                ((k = q(l)), !(k >= H.length - 1) && H[l].textBlock.y + H[l].height + da > H[k].textBlock.y && (H[l].textBlock.y = H[l].textBlock.y + H[l].height - e > e - H[l].textBlock.y ? e + 1 : e - H[l].height - 1));
          }
        ...
        for (var d, e, f, g, m, k, n = 1, l = 0; l < 2 * n; l++) {
          for (
            ...
            !(0 <= p(r) && p(r),
              ...
              (e = +g.y.toFixed(6)),
              !f.isDirty && m && e + d + da > +k.y.toFixed(6) && ((d = g.y + d + da - k.y), (e = a(r, -d)), e < d && (0 < e && (d -= e), (e = a(q(r), d)), e != d)));
            r--
          );
          b();
        }
      ...
      function n(a) {
        for (var b, c, d, e, f = 0; f < P.length; f++)
          (e = 1 === H[f].lineThickness % 2 ? 0.5 : 0),
            ...
            H[f].isDirty ||
            0 == H[f].lineThickness ||
            ((a.strokeStyle = H[f].lineColor), (a.lineWidth = H[f].lineThickness), a.setLineDash && a.setLineDash(N(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke());
      }
      function p(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var t = this.data[a.dataSeriesIndexes[0]], B = t.dataPoints, z = this.plotArea, A = 0.025 * z.width, y = 0.01 * z.width, D = 0, E = z.height - 2 * A, F = Math.min(z.width - 2 * y, 2.8 * z.height), I = !1, R = 0;
          R < B.length;
          R++
        )
          if (
            (!I && "undefined" !== typeof B[R].indexLabel && null !== B[R].indexLabel && 0 < B[R].indexLabel.toString().length && (I = !0),
              !I && "undefined" !== typeof B[R].label && null !== B[R].label && 0 < B[R].label.toString().length && (I = !0),
              (!I && "function" === typeof t.indexLabelFormatter) || "function" === typeof B[R].indexLabelFormatter)
          )
            I = !0;
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== B.length) {
          ...
          "funnel" === t.type
            ? ((aa = s(t.options.neckHeight) ? 0.35 * E : t.neckHeight),
              ...
              "string" === typeof aa && aa.match(/%$/) ? ((aa = parseInt(aa)), (aa = (aa * E) / 100)) : (aa = parseInt(aa)),
              "string" === typeof G && G.match(/%$/) ? ((G = parseInt(G)), (G = (G * a) / 100)) : (G = parseInt(G)),
              aa > E ? (aa = E) : 0 >= aa && (aa = 0),
              G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
            : "pyramid" === t.type && ((G = aa = 0), (t.reversed = t.reversed ? !1 : !0));
          var y = R + a / 2,
            U = R,
            Z = R + a,
            V = t.reversed ? O : Y,
          ...
          if (-1 !== R) {
            if (t.reversed) for (F.push(T), G = R.length - 1; 0 < G; G--) (T += R[G]), F.push(T);
            else for (G = 0; G < R.length; G++) (T += R[G]), F.push(T);
            if (t.reversed) for (G = 0; G < R.length; G++) F[G] < va ? (a.push(K), y.push($), (ca = G)) : (a.push((F[G] - V + X * U) / X), y.push((F[G] - V + ea * Z) / ea));
            else for (G = 0; G < R.length; G++) F[G] < va ? (a.push((F[G] - V + X * U) / X), y.push((F[G] - V + ea * Z) / ea), (ca = G)) : (a.push(K), y.push($));
            for (G = 0; G < R.length - 1; G++)
              (T = t.reversed ? (B[B.length - 1 - G].color ? B[B.length - 1 - G].color : t._colorSet[(B.length - 1 - G) % t._colorSet.length]) : B[G].color ? B[G].color : t._colorSet[G % t._colorSet.length]),
                G === ca
                  ? P.push({ x1: a[G], y1: F[G], x2: y[G], y2: F[G], x3: $, y3: va, x4: y[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: K, y6: va, id: G, height: F[G + 1] - F[G], color: T })
                  : P.push({ x1: a[G], y1: F[G], x2: y[G], y2: F[G], x3: y[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: T });
            var da = 2,
              H = [],
              ga = !1,
              W = [],
            ...
            if (!I)
              for (G = 0; G < B.length; G++)
                (D = t.dataPointIds[G]), (a = { id: D, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: P[t.reversed ? B.length - 1 - G : G] }), (x._eventManager.objectMap[D] = a);
            ...
            this.funnelPyramidClickHandler = function (a) {
              ...
              if (!ga && !x.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && ((b = t.reversed ? B.length - 1 - a.dataPointIndex : a.dataPointIndex), 0 <= b)) {
                a = b;
                if ("funnel" === t.type || "pyramid" === t.type) t.reversed ? (B[B.length - 1 - a].exploded = B[B.length - 1 - a].exploded ? !1 : !0) : (B[a].exploded = B[a].exploded ? !1 : !0);
                l(x, b, 500);
              }
            };
            return {
    ...
    l.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        if ("x" === a)
          ...
          return "y" === a
            ? da(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : (c.yValueFormatString = "#,##0.########"), f._cultureInfo)
            : "z" === a
              ? da(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : (c.zValueFormatString = "#,##0.########"), f._cultureInfo)
              : g;
      });
    };
    ma(E, T);
    E.prototype.setLayout = function () {
      ...
      if ("top" === this.verticalAlign || "bottom" === this.verticalAlign)
        (this.orientation = "horizontal"), (c = this.verticalAlign), (f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width), (m = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height);
          ...
          if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
            ...
            for (var x = 0; x < p.dataPoints.length; x++) {
              var z = p.dataPoints[x],
                ...
                g = z.legendText
                  ...
                  : p.legendText
                    ...
                    : this.itemTextFormatter
                      ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: z })
                      : z.name
                        ? z.name
                        : "DataPoint: " + (x + 1),
                ...
                q = { markerType: q, markerColor: r, text: g, textBlock: null, chartType: p.type, markerSize: v, dataSeriesIndex: n, dataPointIndex: x, markerBorderColor: w, markerBorderThickness: t };
          ...
          if (!(0 >= m || "undefined" === typeof m || 0 >= w || "undefined" === typeof w)) {
            if ("horizontal" === this.orientation) {
              ...
              if (
                !p ||
                p.width +
                Math.round(q.textBlock.width + v + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) >
                f
              )
              ...
              (q.textBlock = new ia(this.ctx, {
                ...
                q.textBlock.measureText(),
                null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (v + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                this.height < m - this.lineHeight ? ((p = { items: [], width: 0 }), k.push(p)) : ((p = k[x]), (x = (x + 1) % k.length)),
      ...
      this.markerSize = v;
      this.rows = k;
      0 < l.length && a.layoutManager.registerSpace(c, { width: this.width + 2 + 2, height: this.height + 5 + 5 });
              ...
              case "doughnut":
                ...
                r < q.radius &&
                  ...
                  ((r = Math.atan2(d - s.y, a - s.x)),
                    ...
                    r > s && r < v && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (h = !0)));
                break;
              case "funnel":
              case "pyramid":
                r = q.funnelSection;
    ...
    x.prototype.createExtraLabelsForLog = function (a) {
      ...
      if (!(5 < a)) {
        ...
        if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
          for (var c = x.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c)
          ...
          if (((f = (0.9 * h) >> 0), (q = 0), !this.chart.panEnabled && 1 <= this._labels.length)) {
                ...
                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                  if (
                    ((this.sessionVariables.labelMaxHeight =
                      0 === this.labelAngle ? m : Math.min((b - f * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)), b)),
                      (n = (k - (l + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) / Math.sin((Math.PI / 180) * Math.abs(-25))),
                    ...
                    if (s(this.options.labelWrap))
                      if (!s(this.options.labelMaxWidth))
                        this.options.labelMaxWidth < f
                          ...
                          : ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth), (this.sessionVariables.labelMaxHeight = m));
                      else if (!s(d))
                  ...
                  ((this.sessionVariables.labelAngle = this.labelAngle),
                    (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? m : Math.min((b - f * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)), b)),
                    (n = 0 != this.labelAngle ? (k - (l + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)) : f),
            ...
            for (c = 0; c < this._labels.length; c++)
              (a = this._labels[c].textBlock),
                ...
                (a.maxHeight = s(this.sessionVariables.labelMaxHeight) ? (this.sessionVariables.labelMaxHeight = m) : this.sessionVariables.labelMaxHeight),
                a.measureText();
        else if ("left" === this._position || "right" === this._position)
          if (
                ...
                s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle
                  ? s(this.options.labelWrap)
                                ...
                                : h >= 3.2 * m && h < 3.6 * m
                                  ...
                                  : h > 3.6 * m && h < 10 * m
                                    ...
                                    (s(this.options.labelFontSize) && 12 < this.labelFontSize && ((this.labelFontSize = Math.floor((12 / 13) * this.labelFontSize)), a.measureText()),
                                      ...
                                      (this.sessionVariables.labelMaxWidth = f),
                                      (this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))))
                      : ((this.sessionVariables.labelMaxHeight = m), (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)))
                    : ((this.sessionVariables.labelMaxWidth = this.labelWrap
                      ...
                      (this.sessionVariables.labelMaxHeight = m))
                  : ((this.sessionVariables.labelAngle = this.labelAngle),
                    (this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? f : Math.min((b - m * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)), m)),
                    s(this.options.labelWrap))
                    ? s(this.options.labelWrap) &&
                    (this.labelWrap && !s(this.options.labelMaxWidth)
                      ...
                      : ((this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : f),
                        (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? m : b),
                        s(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle)))
                    : this.options.labelWrap
                      ? ((this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? m : b), (this.sessionVariables.labelWrap = this.labelWrap), (this.sessionVariables.labelMaxWidth = f))
                      : ((this.sessionVariables.labelMaxHeight = m),
                        s(this.options.labelMaxWidth),
                        (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth),
                        (this.sessionVariables.labelWrap = this.labelWrap));
      ...
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        if ("outside" === f.labelPlacement) {
          ...
          (m = "bottom" === this._position || "top" === this._position ? (0.9 * this.chart.width) >> 0 : (0.9 * this.chart.height) >> 0),
            (x = s(f.options.labelWrap) || f.labelWrap ? ("bottom" === this._position || "top" === this._position ? (0.8 * this.chart.width) >> 0 : (0.8 * this.chart.height) >> 0) : 1.5 * this.labelFontSize),
    ...
    x.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++)
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (var r = q[g].scaleBreaks._appliedBreaks, v = 0; v < r.length && !(r[v].startValue > q[g].viewportMaximum); v++)
      ...
      for (var w = (v = 0), t = 0, x = 0, z = 0, A = 0, y = 0, D, E, F = (h = 0), I, J, L, r = (I = J = L = !1), g = 0; g < q.length; g++)
        q[g] &&
          q[g].title &&
      ...
      if ("normal" === e) {
        for (var x = [], z = [], A = [], y = [], M = [], N = [], O = [], Q = []; 4 > v;) {
          var G = 0,
            ...
            P = 0,
            $ = 0;
          if (c && 0 < c.length) for (A = [], g = P = 0; g < c.length; g++) A.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (P += A[g]), (K += c[g] && !n.isNavigator ? c[g].margin : 0);
          else A.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          O.push(A);
          if (b && 0 < b.length) for (y = [], g = $ = 0; g < b.length; g++) y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), ($ += y[g]), (Z += b[g] ? b[g].margin : 0);
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ((a[g].lineCoordinates.x1 = m),
                  ...
                  ((h = 0),
                    0 < a[g].labelAngle
                      ? E + t > l && (h += 0 < a[g].labelAngle ? E + t - l - $ : 0)
                      : 0 > a[g].labelAngle
                        ? D - w < m && D - w < a[g].viewportMinimum && (F = m - (K + a[g].tickLength + A + D - w + a[g].labelFontSize / 2))
                        : 0 === a[g].labelAngle && (E + t > l && (h = E + t / 2 - l - $), D - w < m && D - w < a[g].viewportMinimum && (F = m - K - a[g].tickLength - A - D + w / 2)),
                    a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h
                      ...
                      : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < F
                        ? (m += F)
                        : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < F && (m += F), 0 < h && (l -= h))),
                  n.panEnabled ? (T = s(n.sessionVariables.axisX.height) ? (n.sessionVariables.axisX.height = T) : n.sessionVariables.axisX.height) : (n.sessionVariables.axisX.height = T),
                  ...
                  (a[g].bounds = { x1: m, y1: h, x2: l, y2: k - (T + e - x[g] - G), width: l - m, height: k - h })),
                (G += x[g] + a[g].margin);
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + P + K)),
                ...
                ((k = d[g]._labels[1]),
                  ...
                  (w = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                  (t = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                n.panEnabled ? (X = s(n.sessionVariables.axisX2.height) ? (n.sessionVariables.axisX2.height = X) : n.sessionVariables.axisX2.height) : (n.sessionVariables.axisX2.height = X),
                (h = Math.round(f.y1)),
                (k = Math.round(f.y2 + d[g].margin)),
                (d[g].lineCoordinates.y1 = h + X + W - V),
                (d[g].lineCoordinates.y2 = h),
                "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - z[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)),
                (d[g].bounds = { x1: m, y1: h + (X + W - z[g] - V), x2: l, y2: k, width: l - m, height: k - h }),
                (V += z[g] + d[g].margin);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (K = n.isNavigator ? 0 : 10),
                ...
                ((m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                  ...
                  (h = Math.round(f.y1 + X + W < Math.max(K, p) ? Math.max(K, p) : f.y1 + X + W)),
                  ...
                  (c[g].lineCoordinates = { x1: m - S, y1: h, x2: l - S, y2: k, height: Math.abs(k - h) }),
                  "inside" === c[g].labelPlacement &&
                  0 < g &&
                  ((c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (A[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0)),
                    (c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2)),
                  (c[g].bounds = { x1: m - (A[g] + S), y1: h, x2: l, y2: k, width: l - m, height: k - h }),
            ...
            for (g = 0; g < b.length; g++)
              b[g] &&
                ((m = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2)),
                  ...
                  (k = Math.round(f.y2 - (T + e + K))),
                  (b[g].lineCoordinates = { x1: m + U, y1: h, x2: m + U, y2: k, height: Math.abs(k - h) }),
                  "inside" === b[g].labelPlacement &&
                  0 < g &&
                  ((b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (y[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2),
                    (b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2)),
                  (b[g].bounds = { x1: m, y1: h, x2: l + (y[g] + U), y2: k, width: l - m, height: k - h }),
              ...
              a[g] &&
                (a[g].calculateValueToPixelConversionParameters(),
                  ...
                  ((D =
                    ...
                    (m = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position),
                    (m = a[g].getApparentDifference(a[g].viewportMinimum, m)),
                    (E = a[g].logarithmic
                      ? (1 < m ? (Math.log(m) / a[g].conversionParameters.lnLogarithmBase) * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1
                      : (0 < m ? m * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              d[g].calculateValueToPixelConversionParameters(),
                ...
                ((D =
                  ...
                  (m = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position),
                  (m = d[g].getApparentDifference(d[g].viewportMinimum, m)),
                  (E = d[g].logarithmic
                    ? (1 < m ? (Math.log(m) / d[g].conversionParameters.lnLogarithmBase) * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1
          ...
          if (0 < v) {
            if (a && 0 < a.length) for (g = 0; g < a.length; g++) r = M[v - 1][g] === M[v][g] ? !0 : !1;
            else r = !0;
            if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = N[v - 1][g] === N[v][g] ? !0 : !1;
            else I = !0;
            if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = O[v - 1][g] === O[v][g] ? !0 : !1;
            else J = !0;
            if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = Q[v - 1][g] === Q[v][g] ? !0 : !1;
            else L = !0;
          }
          if (r && I && J && L) break;
          v++;
        ...
        for (N = []; 4 > v;) {
          ...
          if (a && 0 < a.length) for (F = [], g = U = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), (U += F[g]), (e += a[g] && !n.isNavigator ? a[g].margin : 0);
          else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          M.push(F);
          if (d && 0 < d.length) for (w = [], g = T = 0; g < d.length; g++) w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (T += w[g]), (W += d[g] ? d[g].margin : 0);
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (l = Math.round(f.x2 - T - W > n.width - 10 ? n.width - 10 : f.x2 - T - W)),
                c[g].labelAutoFit &&
                !s(x) &&
                (0 < !a.length && (m = 0 > c[g].labelAngle ? Math.max(m, x) : 0 === c[g].labelAngle ? Math.max(m, x / 2) : m),
                  0 < !d.length && (l = 0 < c[g].labelAngle ? l - z / 2 : 0 === c[g].labelAngle ? l - z / 2 : l)),
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              (b[g].lineCoordinates = {}),
                (m = Math.round(f.x1 + U + e)),
                (l = Math.round(f.x2 - T - W > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - T - W)),
                b[g] && b[g].labelAutoFit && !s(A) && (0 < !a.length && (m = 0 < b[g].labelAngle ? Math.max(m, A) : 0 === b[g].labelAngle ? Math.max(m, A / 2) : m), 0 < !d.length && (l -= y / 2)),
          ...
          if (c && 0 < c.length) for (p = [], g = S = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), (S += p[g] + c[g].margin), (K += c[g].margin);
          else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          E.push(p);
          if (b && 0 < b.length) for (D = [], g = V = 0; g < b.length; g++) D.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (V += D[g]), (Z += b[g].margin);
            ...
            for (g = 0; g < b.length; g++)
              b[g] &&
                ...
                ((k = b[g]._labels[0]),
                  ...
                  (A = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (h = Math.round(f.y2)),
                ...
                (c[g].bounds = { x1: m, y1: h - (p[g] + X + c[g].margin), x2: l, y2: k - (X + c[g].margin), width: l - m, height: p[g] }),
                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                (X += p[g] + c[g].margin);
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((h = Math.round(f.y1)),
                  ...
                  "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - D[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                  (b[g].bounds = { x1: m, y1: h + (b[g].margin + G), x2: l, y2: k, width: l - m, height: V }),
                  b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width),
                  (G += D[g] + b[g].margin));
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++) {
              ...
              k =
                c && 0 < c.length
                  ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - S > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2 - S)
                  : f.y2 > n.height - Math.max(K, 10)
                    ? n.height - Math.max(K, 10)
                    : f.y2;
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] && c[K].labelAutoFit && ((l = 0 > c[K].labelAngle ? Math.max(l, x) : 0 === c[K].labelAngle ? Math.max(l, x / 2) : l), (m = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? l - U : m));
              ...
              a[g].bounds = { x1: l - (F[g] + O), y1: h, x2: l, y2: k, width: l - m, height: k - h };
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++) {
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++)
                  c[K] && c[K].labelAutoFit && ((l = 0 > c[K].labelAngle ? Math.max(l, x) : 0 === c[K].labelAngle ? Math.max(l, x / 2) : l), (m = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? l - T : m));
              if (b && 0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && ((l = b[K].lineCoordinates.x2), (m = l - T));
              ...
              d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: h, x2: l + w[g] + Q, y2: k, width: l - m, height: k - h };
          ...
          if (0 < v) {
            ...
            if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = E[v - 1][g] === E[v][g] ? !0 : !1;
            else J = !0;
            if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = t[v - 1][g] === t[v][g] ? !0 : !1;
            else L = !0;
          }
          if (r && I && J && L) break;
          v++;
    ...
    x.render = function (a, d, c, b, e) {
      ...
      e.restore();
      if (a && 0 < a.length) for (m = 0; m < a.length; m++) a[m].renderGrid(), w && (a[m].createMask(), a[m].renderBreaksBackground());
      ...
      if ("undefined" === typeof this.options.interval) {
        if ("bottom" === this._position || "top" === this._position)
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, m, h = this.viewportMaximum, l = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
              p = this._labels[k];
              if (p.position < this.viewportMinimum) break;
              p.position > this.viewportMaximum ||
                !(k === this._labels.length - 1 || m < (Math.log(h / p.position) * l) / e) ||
                (c.push(p), (h = p.position), (m = p.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
            }
            this._labels = c;
          } else {
            for (k = 0; k < this._labels.length; k++)
              (p = this._labels[k]),
                p.position < this.viewportMinimum || ((m = p.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (c += m));
        ...
        if ("left" === this._position || "right" === this._position)
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (var c = [], n, h = this.viewportMaximum, l = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
              ...
              if (p.position < this.viewportMinimum) break;
              p.position > this.viewportMaximum ||
                !(k === this._labels.length - 1 || n < Math.log(h / p.position) * l) ||
          ...
          if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
            if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
              ...
              for (var h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++)
                d.moveTo(e, m), d.lineTo(this.scaleBreaks._appliedBreaks[h].startPixel + c, m), (e = this.scaleBreaks._appliedBreaks[h].endPixel + b);
        ...
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
          if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
            ...
            for (h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++)
              d.moveTo(m, e), d.lineTo(m, this.scaleBreaks._appliedBreaks[h].startPixel + b), (e = this.scaleBreaks._appliedBreaks[h].endPixel + c);
    ...
    x.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        if ("axisX" === this.type) {
          ...
          "axisY" === this.type &&
            ((e = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
              ...
              (h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1),
        ...
        if ("axisX" === this.type && c) {
                                                                                      ...
                                                                                      : b / (2 * S.monthDuration) <= a
                                                                                        ...
                                                                                        : b / (3 * S.monthDuration) <= a
                                                                                          ...
                                                                                          : b / (6 * S.monthDuration) <= a
                                                                                            ...
                                                                                            : ((this.interval = b / (1 * S.yearDuration) <= a ? 1 : b / (2 * S.yearDuration) <= a ? 2 : b / (4 * S.yearDuration) <= a ? 4 : Math.floor(x.getNiceNumber(b / (a - 1), !0) / S.yearDuration)),
          ...
          if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = "axisX" === this.type ? f + h / 2 : Math.ceil(f / this.interval) * this.interval;
          0 === this.viewportMaximum &&
            ...
            (0 === this.options.viewportMinimum ? (this.viewportMaximum += 10) : 0 === this.options.viewportMaximum && (this.viewportMinimum -= 10),
              this.options && "undefined" === typeof this.options.interval && (this.interval = x.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
        }
        if (null === this.minimum || null === this.maximum)
          if (
            ...
            (this.intervalType = this.valueType = "number"),
              null === this.minimum &&
              ((this.minimum = "axisX" === this.type ? e - h / 2 : Math.floor(e / this.interval) * this.interval),
                (this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum))),
              null === this.maximum &&
              ((this.maximum = "axisX" === this.type ? f + h / 2 : Math.ceil(f / this.interval) * this.interval),
                (this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum))),
    ...
    x.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      if (this.scaleBreaks)
        for (h = 0; h < this.scaleBreaks._appliedBreaks.length; h++)
          if (
            ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue) ||
              (!s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[h].startValue) ||
              (!s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue)) &&
            ((!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue) ||
              (!s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[h].endValue) ||
              (!s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue))
          ) {
      ...
      "axisX" === this.type
        ? ((b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
          ...
          1 === e / b && ((h = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval)), (e *= h), (b /= h)),
        ...
        ((b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
          ...
          1 === b && 1 === e
            ...
            : 1 === e / b
              ? ((h = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), (e *= h), (b /= h))
              : b > e
                ? ((h = Math.min((b / e) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))), 1 <= e ? (b = e / h) : (e = b * h))
                : ((h = Math.min((e / b) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))), 1 !== e && (e *= h), 1 !== b && (b /= h)),
          (f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? (e / b) * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase),
          ...
          if (
            ((b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0),
              ...
              "top" === this.scaleBreaks.parent._position
                ? ((e = this.chart.plotArea.y1), (l = (this.chart.plotArea.y2 + p / 2 + 0.5) << 0))
                : ((e = this.chart.plotArea.y2), (l = (this.chart.plotArea.y1 - p / 2 + 0.5) << 0), (a *= -1)),
    ...
    O.prototype.render = function () {
      ...
      if (0 < d) {
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position)
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0), (h = this.chart.plotArea.y1), (l = this.chart.plotArea.y2), (this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: l });
        else if ("left" === this.parent._position || "right" === this.parent._position)
          (h = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0), (e = this.chart.plotArea.x1), (f = this.chart.plotArea.x2), (this.bounds = { x1: e, y1: h - d / 2, x2: f, y2: l + d / 2 });
        this.ctx.moveTo(e, h);
        this.ctx.lineTo(f, l);
        this.ctx.stroke();
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var y = 0; y < this.parent.dataSeries.length; y++)
            (w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= w.index && ((w.dataSeries = this.parent.dataSeries[y]), null !== w.dataPoint.y && w.dataSeries.visible && n.push(w));
          w = null;
          ...
          if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
            for (var w = Math.abs(a - this.parent.convertValueToPixel(n[y].dataPoint.y[0])), t = 0, r = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (var B = 0; B < n[r].dataPoint.y.length; B++) (t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[B]))), t < w && ((w = t), (y = r));
            ...
            for (var w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), z = (t = 0), r = (y = 0); r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (B = 0; B < n[r].dataPoint.y.length; B++) (t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[B]))), t < w && ((w = t), (y = r));
            ...
            for (var w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), A = (z = t = 0), r = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (B = 0; B < n[r].dataPoint.y.length; B++) (t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[B]))), t < w && ((w = t), (y = r));
              else
                (z += n[r].dataPoint.y),
                  (A = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x),
                  (A = 100 * (z / n[r].dataSeries.plotUnit.dataPointYSums[A])),
                  (t = Math.abs(a - this.parent.convertValueToPixel(A))),
                  t < w && ((w = t), (y = r));
          else
            for (w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = y = t = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (B = 0; B < n[r].dataPoint.y.length; B++) (t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[B]))), t < w && ((w = t), (y = r));
              else (t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y))), t < w && ((w = t), (y = r));
          B = n[y];
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
              ...
              k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.y[b] })
                : s(this.options.label)
                  ? da(s(c) ? B.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo)
                  : this.label;
              ...
              this.value = z;
              k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.y })
                : s(this.options.label)
                  ? da(s(c) ? B.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                  : this.label;
              ...
              this.value = A;
              k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A })
                : s(this.options.label)
                  ? da(s(c) ? A : c, this.valueFormatString, this.chart._cultureInfo)
                  : this.label;
            } else
              (l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(B.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(B.dataPoint.y) << 0),
            ...
            if (A) {
              if ("axisX" === this.parent.type)
                for (r = this.parent.convertPixelToValue({ y: d }), w = null, y = 0; y < this.parent.dataSeries.length; y++)
                  (w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) &&
                    0 <= w.index &&
                    (k.text = this.labelFormatter
                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.x })
                      : s(this.options.label)
                        ? w.dataPoint.label
                        : this.label);
            } else
              "dateTime" === this.parent.valueType
                ? (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.x })
                  : s(this.options.label)
                    ? za(B.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label)
                : "number" === this.parent.valueType &&
                (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.x })
                  : s(this.options.label)
                    ? da(B.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label);
          ...
          if (A) {
            if ("axisX" === this.parent.type)
              for (r = this.parent.convertPixelToValue({ x: a }), w = null, y = 0; y < this.parent.dataSeries.length; y++)
                (w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) &&
                  0 <= w.index &&
                  (k.text = this.labelFormatter
                    ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.x })
          ...
          if (
            ...
            for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), r = t = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (B = 0; B < n[r].dataPoint.y.length; B++) (t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[B]))), t < w && ((w = t), (y = r));
            ...
            for (w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = z = t = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (B = 0; B < n[r].dataPoint.y.length; B++) (t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[B]))), t < w && ((w = t), (y = r));
          ...
          if (
            ...
            "waterfall" === this.parent.dataSeries[y].type
              ? ((v =
                1 === q.lineWidth % 2
                  ? (this.parent.convertValueToPixel(B.dataSeries.dataPointEOs[B.index].cumulativeSum) << 0) + 0.5
                  : this.parent.convertValueToPixel(B.dataSeries.dataPointEOs[B.index].cumulativeSum) << 0),
                (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataSeries.dataPointEOs[B.index].cumulativeSum })
                  : s(this.options.label)
                    ? da(s(c) ? B.dataSeries.dataPointEOs[B.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo)
                    : this.label),
                (this.value = B.dataSeries.dataPointEOs[B.index].cumulativeSum))
              : ((v = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(B.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(B.dataPoint.y) << 0),
                (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? B.dataPoint.y : c })
                  : s(this.options.label)
                    ? da(s(c) ? B.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                    : this.label),
                (this.value = B.dataPoint.y));
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position)
          (b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0), (f = this.chart.plotArea.y1), (h = this.chart.plotArea.y2), (this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h });
        else if ("left" === this.parent._position || "right" === this.parent._position)
          (f = h = v = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0), (b = this.chart.plotArea.x1), (e = this.chart.plotArea.x2), (this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
          if ("left" === this.parent._position || "right" === this.parent._position) {
            A = !1;
            if (this.parent.labels)
            ...
            if (A) {
              if ("axisX" === this.parent.type)
                for (r = this.parent.convertPixelToValue({ y: d }), w = null, y = 0; y < this.parent.dataSeries.length; y++)
                  (w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) &&
                    0 <= w.index &&
                    (k.text = this.labelFormatter
                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(a) : c })
                      : s(this.options.label)
                        ? w.dataPoint.label
                        : this.label);
            } else
              "dateTime" === this.parent.valueType
                ? (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(d) : c })
                  : s(this.options.label)
                    ? za(s(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo)
                    : this.label)
                : "number" === this.parent.valueType &&
                (k.text = this.labelFormatter
                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(d) : c })
                  : s(this.options.label)
                    ? da(s(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo)
                    : this.label);
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position)
              (k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(a) : c })
                : s(this.options.label)
                  ? da(s(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                  : this.label),
                (k.x = b - k.measureText().width / 2),
                k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width),
                k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1),
          ...
          if (A) {
            ...
            "dateTime" === this.parent.valueType
              ? (k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(a) : c })
                : s(this.options.label)
                  ? za(s(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                  : this.label)
              : "number" === this.parent.valueType &&
              (k.text = this.labelFormatter
                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? (0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "") : c })
                : s(this.options.label)
                  ? da(s(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                  : this.label);
          k.x = b - k.measureText().width / 2;
        ...
        if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
          ...
          if (this.chart.axisX)
            for (var v = 0; v < this.chart.axisX.length; v++) {
              for (
                var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[v].convertPixelToValue({ y: d }) : this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, b = 0;
                b < this.chart.axisX[v].dataSeries.length;
                b++
              )
                (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX[v].dataSeries[b]), null !== k.dataPoint.y && k.dataSeries.visible && l.push(k));
              k = null;
            }
          if (this.chart.axisX2)
            for (v = 0; v < this.chart.axisX2.length; v++) {
              h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[v].convertPixelToValue({ y: d }) : this.chart.axisX2[v].convertPixelToValue({ x: a });
              k = null;
              for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX2[v].dataSeries[b]), null !== k.dataPoint.y && k.dataSeries.visible && l.push(k));
              k = null;
            }
              ...
              : "bubble" === b.type
                ...
                : "column" === b.type ||
                  ...
                  : "pie" === b.type || "doughnut" === b.type
                    ? ha(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
        ...
        for (var l = null, s = "", h = 0; h < a.length; h++) {
          ...
          if (0 === h && this.isToolTipDefinedInData && !this.content) {
            this.chart.axisX && 0 < this.chart.axisX.length
              ? (s += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}")
              : this.chart.axisX2 && 0 < this.chart.axisX2.length && (s += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}");
            s += "</br>";
          ...
          null === b.toolTipContent ||
            ...
            ("line" === c.type ||
              ...
              "waterfall" === c.type
              ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += l != c.axisXIndex ? (c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>") : ""),
                (f += b.toolTipContent
                  ? b.toolTipContent
                  : c.toolTipContent
                    ? c.toolTipContent
              ...
              c.visible &&
              (!0 === this.reversed
                ? ((d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d), h < a.length - 1 && (d = "</br>" + d))
                : ((d += this.chart.replaceKeywordsWithValue(f, b, c, e)), h < a.length - 1 && (d += "</br>"))));
        }
        null !== d && (d = s + d);
      } else {
        c = a[0].dataSeries;
          ...
          if (c) {
            ...
            "circle" === b
              ? (c.moveTo(a, d),
                ...
                f && c.fill(),
                l && (h ? c.stroke() : ((s = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = s))))
              : "square" === b
                ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), l && (h ? c.stroke() : ((s = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = s))))
                : "triangle" === b
                  ? (c.beginPath(),
