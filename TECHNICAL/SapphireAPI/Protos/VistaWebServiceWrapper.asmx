...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/VistaWebServiceWrapper.asmx?disco" />
    ...
    <title>
	VistaWebServiceWrapper Web Service
</title></head>
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">VistaWebServiceWrapper</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="VistaWebServiceWrapper.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="VistaWebServiceWrapper.asmx?op=CheckSeatSatus">CheckSeatSatus</a>
              ...
              <li>
                <a href="VistaWebServiceWrapper.asmx?op=GetOrderStatus">GetOrderStatus</a>
              ...
              <li>
                <a href="VistaWebServiceWrapper.asmx?op=GetSeatLayout">GetSeatLayout</a>
              ...
              <li>
                <a href="VistaWebServiceWrapper.asmx?op=cancelVistaOrder">cancelVistaOrder</a>
              ...
              <li>
                <a href="VistaWebServiceWrapper.asmx?op=commitVistaOrder">commitVistaOrder</a>
              ...
              <li>
                <a href="VistaWebServiceWrapper.asmx?op=createVistaOrder">createVistaOrder</a>
              ...
              <li>
                <a href="VistaWebServiceWrapper.asmx?op=postVistaOrder">postVistaOrder</a>
...
<script type="text/javascript" src="http://localhost:55099/e3cc671a153d44f696a7498903fd82d2/browserLink" async="async" id="__browserLink_initializationData" data-requestId="9a31999438df4eaca78b9aef6ad2b300" data-appName="Unknown"></script>
<!-- End Browser Link -->
